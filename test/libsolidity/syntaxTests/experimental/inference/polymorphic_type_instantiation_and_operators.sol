...
// Info 4164: (63-73): Inferred type: tfun('bb:type, T('bb:type))
...
// Info 4164: (398-405): Inferred type: 'y:(type, P1)
// Info 4164: (399-404): Inferred type: 'y:(type, P1)
// Info 4164: (402-404): Inferred type: 'y:(type, P1)
// Info 4164: (415-456): Inferred type: (T('y:(type, P1)), T('y:(type, P1))) -> T('y:(type, P1))
// Info 4164: (427-445): Inferred type: (T('y:(type, P1)), T('y:(type, P1)))
// Info 4164: (428-435): Inferred type: T('y:(type, P1))
// Info 4164: (431-435): Inferred type: T('y:(type, P1))
// Info 4164: (431-432): Inferred type: tfun('y:(type, P1), T('y:(type, P1)))
// Info 4164: (433-434): Inferred type: 'y:(type, P1)
// Info 4164: (437-444): Inferred type: T('y:(type, P1))
// Info 4164: (440-444): Inferred type: T('y:(type, P1))
// Info 4164: (440-441): Inferred type: tfun('y:(type, P1), T('y:(type, P1)))
// Info 4164: (442-443): Inferred type: 'y:(type, P1)
// Info 4164: (449-453): Inferred type: T('y:(type, P1))
// Info 4164: (449-450): Inferred type: tfun('y:(type, P1), T('y:(type, P1)))
// Info 4164: (451-452): Inferred type: 'y:(type, P1)
// Info 4164: (460-535): Inferred type: void
// Info 4164: (475-482): Inferred type: 'z:(type, P2)
// Info 4164: (476-481): Inferred type: 'z:(type, P2)
// Info 4164: (479-481): Inferred type: 'z:(type, P2)
// Info 4164: (493-533): Inferred type: (T('z:(type, P2)), T('z:(type, P2))) -> bool
// Info 4164: (504-522): Inferred type: (T('z:(type, P2)), T('z:(type, P2)))
// Info 4164: (505-512): Inferred type: T('z:(type, P2))
// Info 4164: (508-512): Inferred type: T('z:(type, P2))
// Info 4164: (508-509): Inferred type: tfun('z:(type, P2), T('z:(type, P2)))
// Info 4164: (510-511): Inferred type: 'z:(type, P2)
// Info 4164: (514-521): Inferred type: T('z:(type, P2))
// Info 4164: (517-521): Inferred type: T('z:(type, P2))
// Info 4164: (517-518): Inferred type: tfun('z:(type, P2), T('z:(type, P2)))
// Info 4164: (519-520): Inferred type: 'z:(type, P2)
// Info 4164: (526-530): Inferred type: bool
// Info 4164: (537-618): Inferred type: void
// Info 4164: (552-565): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (553-564): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (556-564): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (557-559): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (561-563): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (575-616): Inferred type: (T('ba:(type, P1, P2)), T('ba:(type, P1, P2))) -> T('ba:(type, P1, P2))
// Info 4164: (587-605): Inferred type: (T('ba:(type, P1, P2)), T('ba:(type, P1, P2)))
// Info 4164: (588-595): Inferred type: T('ba:(type, P1, P2))
// Info 4164: (591-595): Inferred type: T('ba:(type, P1, P2))
// Info 4164: (591-592): Inferred type: tfun('ba:(type, P1, P2), T('ba:(type, P1, P2)))
// Info 4164: (593-594): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (597-604): Inferred type: T('ba:(type, P1, P2))
// Info 4164: (600-604): Inferred type: T('ba:(type, P1, P2))
// Info 4164: (600-601): Inferred type: tfun('ba:(type, P1, P2), T('ba:(type, P1, P2)))
// Info 4164: (602-603): Inferred type: 'ba:(type, P1, P2)
// Info 4164: (609-613): Inferred type: T('ba:(type, P1, P2))
// Info 4164: (609-610): Inferred type: tfun('ba:(type, P1, P2), T('ba:(type, P1, P2)))
// Info 4164: (611-612): Inferred type: 'ba:(type, P1, P2)
