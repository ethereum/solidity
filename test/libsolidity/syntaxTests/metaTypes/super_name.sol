...
// ----
// TypeError 4259: (426-431='super'): Invalid type for argument in the function call. An enum type, contract type or an integer type is required, but type(contract super B) provided.
