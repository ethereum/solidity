...
// ----
// TypeError 4259: (177-182='super'): Invalid type for argument in the function call. An enum type, contract type or an integer type is required, but type(contract super SuperTest) provided.
