...
// ----
// TypeError 8476: (380-387): In contract "D", the "super" call resolves to external function "X.f", which cannot be called internally. Make "X.f" public, or change the order of base contracts in "D".
