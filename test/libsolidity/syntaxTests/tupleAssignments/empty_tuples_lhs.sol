...
// TypeError 7407: (47-48='2'): Type int_const 2 is not implicitly convertible to expected type tuple().
// TypeError 5547: (86-88='()'): Empty tuple on the left hand side.
// TypeError 5547: (173-175='()'): Empty tuple on the left hand side.
// TypeError 7407: (178-182='f2()'): Type tuple(uint256,uint256) is not implicitly convertible to expected type tuple().
// TypeError 5132: (166-182='return () = f2()'): Different number of arguments in return statement than in returns declaration.
...
// TypeError 9322: (389-396='require'): No matching declaration found after argument-dependent lookup.
