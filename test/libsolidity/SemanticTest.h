...
public:
	...
	/// the input stream \param _stream. Each function call is represented using a
	/// `FunctionCallTest` and added to the list of call to be executed when `run()` is called.
