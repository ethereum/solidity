...
// SMTIgnoreCex: yes
// ----
// Warning 6328: (120-147='assert(msg.data.length > 4)'): CHC: Assertion violation happens here.
// Warning 6328: (467-494='assert(msg.data[3] == 0x8f)'): CHC: Assertion violation happens here.
