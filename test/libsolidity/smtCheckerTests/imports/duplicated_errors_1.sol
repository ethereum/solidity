...
// SMTSolvers: smtlib2
// ----
// Warning 6328: (b.sol:62-75='assert(x > x)'): CHC: Assertion violation might happen here.
// Warning 3996: CHC analysis was not possible. No Horn solver was available. None of the installed solvers was enabled.
// Warning 7812: (b.sol:62-75='assert(x > x)'): BMC: Assertion violation might happen here.
...
// Warning 6328: (c.sol:68-81='assert(x < x)'): CHC: Assertion violation might happen here.
// Warning 7812: (c.sol:68-81='assert(x < x)'): BMC: Assertion violation might happen here.
