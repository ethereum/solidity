...
BOOST_AUTO_TEST_CASE(storage_layout_simple)
{
	MemberList members(MemberList::MemberMap({
		{string("first"), Type::fromElementaryTypeName(ElementaryTypeNameToken(Token::UIntM, "128"))},
		{string("second"), Type::fromElementaryTypeName(ElementaryTypeNameToken(Token::UIntM, "120"))},
		{string("wraps"), Type::fromElementaryTypeName(ElementaryTypeNameToken(Token::UIntM, "16"))}
	}));
...
BOOST_AUTO_TEST_CASE(storage_layout_mapping)
{
	MemberList members(MemberList::MemberMap({
		...
		{string("second"), make_shared<MappingType>(
			Type::fromElementaryTypeName(ElementaryTypeNameToken(Token::UIntM, "8")),
			Type::fromElementaryTypeName(ElementaryTypeNameToken(Token::UIntM, "8"))
		)},
		{string("third"), Type::fromElementaryTypeName(ElementaryTypeNameToken(Token::UIntM, "16"))},
