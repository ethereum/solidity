...
class ASTJSONPropertyTest: public TestCase
{
public:
	static std::unique_ptr<TestCase> create(Config const& _config)
	{
		return std::make_unique<ASTJSONPropertyTest>(_config.filename);
	}
	ASTJSONPropertyTest(std::string const& _filename);
...
private:
	bool checkASTProperty(std::string _property, Json::Value const& _node);
	bool runTest(
