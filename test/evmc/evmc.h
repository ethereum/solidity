 ...
 */
typedef evmc_bytes32 (
	*evmc_get_storage_fn
)(struct evmc_host_context* context, const evmc_address* address, const evmc_bytes32* key);
 ...
 */
typedef enum evmc_storage_status (*evmc_set_storage_fn)(
 ...
 */
typedef size_t (*evmc_copy_code_fn)(
	struct evmc_host_context* context,
	const evmc_address* address,
	size_t code_offset,
	uint8_t* buffer_data,
...
)(struct evmc_host_context* context, const evmc_address* address, const evmc_address* beneficiary);
...
typedef struct evmc_result (
	*evmc_call_fn
)(struct evmc_host_context* context, const struct evmc_message* msg);
...
typedef enum evmc_set_option_result (
	*evmc_set_option_fn
)(struct evmc_vm* vm, char const* name, char const* value);
 ...
 */
typedef struct evmc_result (*evmc_execute_fn)(
	struct evmc_vm* vm,
