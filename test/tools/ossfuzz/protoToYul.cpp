...
const std::string yul::test::yul_fuzzer::createHex(std::string const& _hexBytes)
{
...
const std::string yul::test::yul_fuzzer::createAlphaNum(std::string const& _strBytes)
{
