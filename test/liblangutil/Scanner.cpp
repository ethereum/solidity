...
BOOST_AUTO_TEST_CASE(bin_prefix_only)
{
	TestScanner scanner("{ bin");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
	BOOST_CHECK_EQUAL(scanner.currentError(), ScannerError::IllegalToken);
	scanner.reset("{ bin");
...
BOOST_AUTO_TEST_CASE(bin_invalid_space)
{
	TestScanner scanner("{ bin ");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
...
BOOST_AUTO_TEST_CASE(bin_invalid_token)
{
	TestScanner scanner("{ bin test");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
	BOOST_CHECK_EQUAL(scanner.currentError(), ScannerError::IllegalToken);
	scanner.reset("{ bin test");
	scanner.scanner->setScannerMode(ScannerKind::Yul);
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
	BOOST_CHECK_EQUAL(scanner.currentError(), ScannerError::IllegalToken);
...
BOOST_AUTO_TEST_CASE(valid_bin_literal)
{
	TestScanner scanner("{ bin\"00110101\"");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::BinStringLiteral);
	BOOST_CHECK_EQUAL(scanner.currentLiteral(), std::string("5", 1));
}

BOOST_AUTO_TEST_CASE(invalid_short_bin_literal)
{
	TestScanner scanner("{ bin\"001100110\"");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
	BOOST_CHECK_EQUAL(scanner.currentError(), ScannerError::IllegalBinString);
}

BOOST_AUTO_TEST_CASE(invalid_bin_literal_with_space)
{
	TestScanner scanner("{ bin\"00110101 \"");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
...
BOOST_AUTO_TEST_CASE(invalid_bin_literal_with_wrong_quotes)
{
	TestScanner scanner("{ bin\"00110101'");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
...
BOOST_AUTO_TEST_CASE(invalid_bin_literal_nonbin_string)
{
	TestScanner scanner("{ bin\"hello\"");
	BOOST_CHECK_EQUAL(scanner.currentToken(), Token::LBrace);
	BOOST_CHECK_EQUAL(scanner.next(), Token::Illegal);
	BOOST_CHECK_EQUAL(scanner.currentError(), ScannerError::IllegalBinString);
}
