...
//         {
//             let _2 := add(calldataload(0x04), mul(i_1, 0xc0))
//             let k := 0
//             let a := calldataload(add(_2, 0x44))
//             let c := challenge
//             switch eq(add(i_1, 0x01), n)
//             case 1 {
//                 k := kn
...
//             }
//             let gammaX := calldataload(add(_2, 100))
//             let sigmaX := calldataload(add(_2, 164))
//             let _3 := 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47
//             if iszero(and(and(and(eq(mod(a, _1), a), gt(a, 0x01)), and(eq(mod(k, _1), k), gt(k, 0x01))), and(eq(addmod(mulmod(mulmod(sigmaX, sigmaX, _3), sigmaX, _3), 3, _3), mulmod(calldataload(add(_2, 196)), calldataload(add(_2, 196)), _3)), eq(addmod(mulmod(mulmod(gammaX, gammaX, _3), gammaX, _3), 3, _3), mulmod(calldataload(add(_2, 132)), calldataload(add(_2, 132)), _3)))))
//             {
//                 mstore(0, 400)
//                 revert(0, 0x20)
//             }
//             switch gt(add(i_1, 0x01), m)
//             case 1 {
...
//                 mstore(0x280, mload(0x40))
//                 mstore(0x1e0, mload(0xe0))
//                 mstore(0x200, sub(_3, mload(0x100)))
//             }
//             if gt(i_1, m)
//             {
//                 mstore(0x60, c)
...
//         if lt(m, n)
//         {
//             let _4 := 0x90689d0585ff075ec9e99ad690c3395bc4b313370b38ef355acdadcd122975b
//             let _5 := 0x12c85ea5db8c6deb4aab71808dcb408fe3d1e7690c43d37b4ce6cc0166fa7daa
//             let _6 := 0x198e9393920d483a7260bfb731fb5d25f1aa493335a9e71297e485b7aef312c2
//             let _7 := 0x1800deef121f1e76426a00665e5c4479674322d4f75edadd46debd5cd992f6ed
//             if or(or(or(or(or(or(or(iszero(calldataload(100)), iszero(calldataload(132))), iszero(calldataload(164))), iszero(calldataload(196))), eq(calldataload(100), _7)), eq(calldataload(132), _6)), eq(calldataload(164), _5)), eq(calldataload(196), _4))
//             {
//                 mstore(0, 400)
//                 revert(0, 0x20)
//             }
...
//             mstore(0x140, calldataload(100))
//             mstore(0x120, calldataload(132))
//             mstore(0x180, calldataload(164))
//             mstore(0x160, calldataload(196))
//             let success := call(gas(), 8, 0, 0x20, 0x180, 0x20, 0x20)
//             if or(iszero(success), iszero(mload(0x20)))
//             {
//                 mstore(0, 400)
