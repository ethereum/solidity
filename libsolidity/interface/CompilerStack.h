...
private:
	...
	/// Constructs the complete (unoptimized) IR output for the specified contract by linking its
	/// source with the sources of all its dependencies. Must not be run before all the necessary
	/// sources have been generated by @a generateIR().
	/// @returns source code of a complete Yul object.
