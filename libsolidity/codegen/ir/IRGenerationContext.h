...
public:
	...
	std::string generateInternalDispatchFunction(Arity const& _arity);
	std::string generateInternalDispatchFunction(Arity const& _arity, std::set<FunctionDefinition const*> const& _functions);
