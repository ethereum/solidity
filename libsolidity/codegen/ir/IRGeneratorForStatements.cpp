...
void IRGeneratorForStatements::endVisit(FunctionCall const& _functionCall)
{
	...
	{
		FunctionDefinition const* unresolvedFunctionDef = getReferencedFunctionDeclaration(_functionCall.expression());
		...
		{
			Arity arity = getFunctionArity(*functionType);
			define(_functionCall) <<
	...
	case FunctionType::Kind::Creation:
	{
		...
		t("object", buildCreationObjectName(*contract));
		t("abiEncode",
...
void IRGeneratorForStatements::endVisit(MemberAccess const& _memberAccess)
{
	...
	case Type::Category::Magic:
		...
		else if (member == "creationCode" || member == "runtimeCode")
		{
			...
			("objectName", buildCreationObjectName(contract))
