...
)
{
	...
	t("CreationObject", buildCreationObjectName(_contract));
	...
	if (constructor && !constructor->parameters().empty())
	{
		...
		t(
			...
			m_utils.copyConstructorArgumentsToMemoryFunction(_contract, buildCreationObjectName(_contract))
		);
	}
	...
	t("RuntimeObject", buildRuntimeObjectName(_contract));
...
{
	string functionName = buildFunctionName(_function);
...
{
	string functionName = buildFunctionName(_varDecl);
...
string IRGenerator::deployCode(ContractDefinition const& _contract)
{
	...
	t("object", buildRuntimeObjectName(_contract));
