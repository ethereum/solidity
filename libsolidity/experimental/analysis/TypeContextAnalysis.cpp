...
void TypeContextAnalysis::endVisit(FunctionDefinition const& _functionDefinition)
{
	solAssert(m_expressionContext == ExpressionContext::Term);
...
void TypeContextAnalysis::endVisit(Return const& _return)
{
...
bool TypeContextAnalysis::visit(InlineAssembly const& _inlineAssembly)
{
...
void TypeContextAnalysis::endVisit(VariableDeclarationStatement const& _variableDeclarationStatement)
{
	solAssert(m_expressionContext == ExpressionContext::Term);
...
experimental::Type TypeContextAnalysis::memberType(Type _type, std::string _memberName, langutil::SourceLocation _location)
{
...
void TypeContextAnalysis::endVisit(MemberAccess const& _memberAccess)
{
...
bool TypeContextAnalysis::visit(FunctionCall const&) { return true; }
...
bool TypeContextAnalysis::visit(Literal const& _literal)
{
...
TypeRegistration::TypeClassInstantiations const& typeClassInstantiations(Analysis const& _analysis, TypeClass _class)
{
	...
	auto const& inferenceAnnotation = _analysis.annotation<TypeContextAnalysis>();
...
bool TypeContextAnalysis::visitNode(ASTNode const& _node)
{
