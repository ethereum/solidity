...
/// Parse a JSON string (@a _input) with enabled strict-mode and writes resulting JSON object to (@a
/// _json) \param _input JSON input string \param _json [out] resulting JSON object \param _errs
/// [out] Formatted error messages \return \c true if the document was successfully parsed, \c false
