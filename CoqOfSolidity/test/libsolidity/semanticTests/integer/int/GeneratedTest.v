...
Require test.libsolidity.semanticTests.integer.int.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.integer.int.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.integer.int.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.integer.int.test.codes.
