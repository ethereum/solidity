...
Require test.libsolidity.semanticTests.integer.uint.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.integer.uint.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.integer.uint.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.integer.uint.test.codes.
