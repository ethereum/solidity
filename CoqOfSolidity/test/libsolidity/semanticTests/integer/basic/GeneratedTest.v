...
Require test.libsolidity.semanticTests.integer.basic.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.integer.basic.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.integer.basic.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.integer.basic.C.codes.
