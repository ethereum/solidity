...
Require test.libsolidity.semanticTests.expressions.conditional_expression_storage_memory_1.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.conditional_expression_storage_memory_1.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.conditional_expression_storage_memory_1.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.conditional_expression_storage_memory_1.test.codes.
