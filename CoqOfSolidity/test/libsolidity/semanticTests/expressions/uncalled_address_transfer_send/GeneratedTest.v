...
Require test.libsolidity.semanticTests.expressions.uncalled_address_transfer_send.TransferTest.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.uncalled_address_transfer_send.TransferTest.TransferTest.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.uncalled_address_transfer_send.TransferTest.TransferTest.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.uncalled_address_transfer_send.TransferTest.codes.
