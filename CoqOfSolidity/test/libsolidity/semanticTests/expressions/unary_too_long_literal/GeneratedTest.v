...
Require test.libsolidity.semanticTests.expressions.unary_too_long_literal.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.unary_too_long_literal.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.unary_too_long_literal.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.unary_too_long_literal.C.codes.
