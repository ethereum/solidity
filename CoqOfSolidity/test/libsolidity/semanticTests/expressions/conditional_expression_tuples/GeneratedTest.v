...
Require test.libsolidity.semanticTests.expressions.conditional_expression_tuples.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.conditional_expression_tuples.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.conditional_expression_tuples.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.conditional_expression_tuples.test.codes.
