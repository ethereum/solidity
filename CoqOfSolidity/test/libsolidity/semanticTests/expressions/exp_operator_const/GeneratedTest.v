...
Require test.libsolidity.semanticTests.expressions.exp_operator_const.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.exp_operator_const.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.exp_operator_const.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.exp_operator_const.test.codes.
