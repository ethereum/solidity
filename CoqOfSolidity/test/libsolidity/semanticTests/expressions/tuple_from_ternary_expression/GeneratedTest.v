...
Require test.libsolidity.semanticTests.expressions.tuple_from_ternary_expression.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.tuple_from_ternary_expression.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.tuple_from_ternary_expression.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.tuple_from_ternary_expression.C.codes.
