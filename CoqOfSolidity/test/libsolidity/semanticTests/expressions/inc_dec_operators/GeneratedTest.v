...
Require test.libsolidity.semanticTests.expressions.inc_dec_operators.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.expressions.inc_dec_operators.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.expressions.inc_dec_operators.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.expressions.inc_dec_operators.test.codes.
