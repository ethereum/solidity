...
Require test.libsolidity.semanticTests.inheritance.value_for_constructor.Helper.
Require test.libsolidity.semanticTests.inheritance.value_for_constructor.Main.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.value_for_constructor.Main.Main.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.value_for_constructor.Main.Main.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.value_for_constructor.Main.codes.
