...
Require test.libsolidity.semanticTests.inheritance.address_overload_resolution.C.
Require test.libsolidity.semanticTests.inheritance.address_overload_resolution.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.address_overload_resolution.D.D.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.address_overload_resolution.D.D.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.address_overload_resolution.D.codes.
