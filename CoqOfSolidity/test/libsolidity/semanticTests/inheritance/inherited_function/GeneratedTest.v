...
Require test.libsolidity.semanticTests.inheritance.inherited_function.A.
Require test.libsolidity.semanticTests.inheritance.inherited_function.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.inherited_function.B.codes.
