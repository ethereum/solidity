...
Require test.libsolidity.semanticTests.inheritance.overloaded_function_call_resolve_to_first.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.overloaded_function_call_resolve_to_first.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.overloaded_function_call_resolve_to_first.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.overloaded_function_call_resolve_to_first.test.codes.
