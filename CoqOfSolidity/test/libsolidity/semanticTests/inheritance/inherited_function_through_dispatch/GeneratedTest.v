...
Require test.libsolidity.semanticTests.inheritance.inherited_function_through_dispatch.A.
Require test.libsolidity.semanticTests.inheritance.inherited_function_through_dispatch.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function_through_dispatch.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function_through_dispatch.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.inherited_function_through_dispatch.B.codes.
