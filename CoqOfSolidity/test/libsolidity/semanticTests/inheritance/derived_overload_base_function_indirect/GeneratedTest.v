...
Require test.libsolidity.semanticTests.inheritance.derived_overload_base_function_indirect.A.
Require test.libsolidity.semanticTests.inheritance.derived_overload_base_function_indirect.B.
Require test.libsolidity.semanticTests.inheritance.derived_overload_base_function_indirect.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.derived_overload_base_function_indirect.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.derived_overload_base_function_indirect.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.derived_overload_base_function_indirect.C.codes.
