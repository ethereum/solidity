...
Require test.libsolidity.semanticTests.inheritance.inherited_constant_state_var.A.
Require test.libsolidity.semanticTests.inheritance.inherited_constant_state_var.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_constant_state_var.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_constant_state_var.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.inherited_constant_state_var.B.codes.
