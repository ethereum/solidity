...
Require test.libsolidity.semanticTests.inheritance.explicit_base_class.Base.
Require test.libsolidity.semanticTests.inheritance.explicit_base_class.BaseBase.
Require test.libsolidity.semanticTests.inheritance.explicit_base_class.Derived.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.explicit_base_class.Derived.Derived.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.explicit_base_class.Derived.Derived.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.explicit_base_class.Derived.codes.
