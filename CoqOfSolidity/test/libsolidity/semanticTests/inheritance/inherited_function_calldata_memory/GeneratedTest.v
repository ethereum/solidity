...
Require test.libsolidity.semanticTests.inheritance.inherited_function_calldata_memory.A.
Require test.libsolidity.semanticTests.inheritance.inherited_function_calldata_memory.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function_calldata_memory.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function_calldata_memory.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.inherited_function_calldata_memory.B.codes.
