...
Require test.libsolidity.semanticTests.inheritance.inherited_function_from_a_library.A.
Require test.libsolidity.semanticTests.inheritance.inherited_function_from_a_library.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function_from_a_library.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inheritance.inherited_function_from_a_library.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inheritance.inherited_function_from_a_library.B.codes.
