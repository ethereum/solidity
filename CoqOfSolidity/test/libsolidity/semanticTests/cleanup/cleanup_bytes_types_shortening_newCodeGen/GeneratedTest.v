...
Require test.libsolidity.semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.cleanup.cleanup_bytes_types_shortening_newCodeGen.C.codes.
