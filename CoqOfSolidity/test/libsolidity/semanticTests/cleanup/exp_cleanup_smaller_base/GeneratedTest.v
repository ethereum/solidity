...
Require test.libsolidity.semanticTests.cleanup.exp_cleanup_smaller_base.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.exp_cleanup_smaller_base.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.exp_cleanup_smaller_base.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.cleanup.exp_cleanup_smaller_base.C.codes.
