...
Require test.libsolidity.semanticTests.cleanup.indexed_log_topic_during_explicit_downcast.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.indexed_log_topic_during_explicit_downcast.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.indexed_log_topic_during_explicit_downcast.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.cleanup.indexed_log_topic_during_explicit_downcast.C.codes.
