...
Require test.libsolidity.semanticTests.cleanup.cleanup_address_types_v2.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.cleanup_address_types_v2.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.cleanup_address_types_v2.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.cleanup.cleanup_address_types_v2.C.codes.
