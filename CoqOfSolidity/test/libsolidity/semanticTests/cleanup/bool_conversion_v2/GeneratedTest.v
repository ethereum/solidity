...
Require test.libsolidity.semanticTests.cleanup.bool_conversion_v2.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.bool_conversion_v2.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.cleanup.bool_conversion_v2.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.cleanup.bool_conversion_v2.C.codes.
