...
Require test.libsolidity.semanticTests.modifiers.modifer_recursive.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.modifer_recursive.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.modifer_recursive.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.modifiers.modifer_recursive.C.codes.
