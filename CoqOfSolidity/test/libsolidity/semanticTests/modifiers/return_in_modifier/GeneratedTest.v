...
Require test.libsolidity.semanticTests.modifiers.return_in_modifier.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.return_in_modifier.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.return_in_modifier.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.modifiers.return_in_modifier.C.codes.
