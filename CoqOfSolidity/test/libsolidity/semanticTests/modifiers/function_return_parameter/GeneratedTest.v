...
Require test.libsolidity.semanticTests.modifiers.function_return_parameter.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.function_return_parameter.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.function_return_parameter.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.modifiers.function_return_parameter.B.codes.
