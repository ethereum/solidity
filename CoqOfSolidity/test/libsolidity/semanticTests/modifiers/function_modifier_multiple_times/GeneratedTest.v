...
Require test.libsolidity.semanticTests.modifiers.function_modifier_multiple_times.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.function_modifier_multiple_times.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.function_modifier_multiple_times.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.modifiers.function_modifier_multiple_times.C.codes.
