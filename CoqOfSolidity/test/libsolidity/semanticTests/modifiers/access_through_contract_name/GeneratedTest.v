...
Require test.libsolidity.semanticTests.modifiers.access_through_contract_name.A.
Require test.libsolidity.semanticTests.modifiers.access_through_contract_name.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.access_through_contract_name.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.modifiers.access_through_contract_name.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.modifiers.access_through_contract_name.C.codes.
