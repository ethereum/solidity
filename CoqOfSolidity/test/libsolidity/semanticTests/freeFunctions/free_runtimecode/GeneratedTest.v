...
Require test.libsolidity.semanticTests.freeFunctions.free_runtimecode.C.
Require test.libsolidity.semanticTests.freeFunctions.free_runtimecode.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.freeFunctions.free_runtimecode.D.D.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.freeFunctions.free_runtimecode.D.D.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.freeFunctions.free_runtimecode.D.codes.
