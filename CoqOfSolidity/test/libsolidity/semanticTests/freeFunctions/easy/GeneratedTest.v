...
Require test.libsolidity.semanticTests.freeFunctions.easy.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.freeFunctions.easy.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.freeFunctions.easy.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.freeFunctions.easy.C.codes.
