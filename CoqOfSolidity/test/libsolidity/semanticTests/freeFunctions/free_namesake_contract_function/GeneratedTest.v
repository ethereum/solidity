...
Require test.libsolidity.semanticTests.freeFunctions.free_namesake_contract_function.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.freeFunctions.free_namesake_contract_function.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.freeFunctions.free_namesake_contract_function.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.freeFunctions.free_namesake_contract_function.C.codes.
