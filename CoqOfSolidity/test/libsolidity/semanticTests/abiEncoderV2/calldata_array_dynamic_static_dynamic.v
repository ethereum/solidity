    ...
    | [] =>
      let _ :=
        M.define (|
          [ "m" ],
          M.call (|
            NewExpression Ty.array (Ty.array (Ty.array (Ty.path "uint8") None) (Some (Value.Integer 1))) None
,
            [
              Value.Integer 1
            ]
    ...
    | [] =>
      let _ :=
        M.define (|
          [ "m" ],
          M.call (|
            NewExpression Ty.array (Ty.array (Ty.array (Ty.path "uint256") None) (Some (Value.Integer 2))) None
,
            [
              Value.Integer 1
            ]
