...
Require test.libsolidity.semanticTests.libraries.internal_call_attached_with_parentheses.C.
Require test.libsolidity.semanticTests.libraries.internal_call_attached_with_parentheses.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_call_attached_with_parentheses.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_call_attached_with_parentheses.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.libraries.internal_call_attached_with_parentheses.C.codes.
