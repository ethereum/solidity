...
Require test.libsolidity.semanticTests.libraries.stub_internal.C.
Require test.libsolidity.semanticTests.libraries.stub_internal.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.libraries.stub_internal.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.libraries.stub_internal.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.libraries.stub_internal.C.codes.
