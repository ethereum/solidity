...
Require test.libsolidity.semanticTests.libraries.internal_library_function_calling_private.C.
Require test.libsolidity.semanticTests.libraries.internal_library_function_calling_private.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_library_function_calling_private.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_library_function_calling_private.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.libraries.internal_library_function_calling_private.C.codes.
