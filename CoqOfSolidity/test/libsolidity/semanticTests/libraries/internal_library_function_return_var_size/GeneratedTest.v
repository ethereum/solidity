...
Require test.libsolidity.semanticTests.libraries.internal_library_function_return_var_size.C.
Require test.libsolidity.semanticTests.libraries.internal_library_function_return_var_size.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_library_function_return_var_size.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_library_function_return_var_size.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.libraries.internal_library_function_return_var_size.C.codes.
