...
Require test.libsolidity.semanticTests.libraries.internal_library_function_attached_to_struct.C.
Require test.libsolidity.semanticTests.libraries.internal_library_function_attached_to_struct.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_library_function_attached_to_struct.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.libraries.internal_library_function_attached_to_struct.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.libraries.internal_library_function_attached_to_struct.C.codes.
