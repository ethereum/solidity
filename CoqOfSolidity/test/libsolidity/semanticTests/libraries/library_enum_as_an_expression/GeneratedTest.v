...
Require test.libsolidity.semanticTests.libraries.library_enum_as_an_expression.Arst.
Require test.libsolidity.semanticTests.libraries.library_enum_as_an_expression.Tsra.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.libraries.library_enum_as_an_expression.Tsra.Tsra.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.libraries.library_enum_as_an_expression.Tsra.Tsra.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.libraries.library_enum_as_an_expression.Tsra.codes.
