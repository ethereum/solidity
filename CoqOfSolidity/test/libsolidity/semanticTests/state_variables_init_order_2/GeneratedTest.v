...
Require test.libsolidity.semanticTests.state_variables_init_order_2.A.
Require test.libsolidity.semanticTests.state_variables_init_order_2.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state_variables_init_order_2.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state_variables_init_order_2.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state_variables_init_order_2.B.codes.
