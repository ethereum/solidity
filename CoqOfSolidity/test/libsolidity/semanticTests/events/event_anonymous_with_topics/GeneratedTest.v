...
Require test.libsolidity.semanticTests.events.event_anonymous_with_topics.ClientReceipt.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_anonymous_with_topics.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_anonymous_with_topics.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_anonymous_with_topics.ClientReceipt.codes.
