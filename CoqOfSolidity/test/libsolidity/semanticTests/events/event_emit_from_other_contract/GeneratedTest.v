...
Require test.libsolidity.semanticTests.events.event_emit_from_other_contract.C.
Require test.libsolidity.semanticTests.events.event_emit_from_other_contract.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_emit_from_other_contract.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_emit_from_other_contract.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_emit_from_other_contract.C.codes.
