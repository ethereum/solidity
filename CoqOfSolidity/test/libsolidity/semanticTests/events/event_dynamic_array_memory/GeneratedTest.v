...
Require test.libsolidity.semanticTests.events.event_dynamic_array_memory.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_dynamic_array_memory.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_dynamic_array_memory.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_dynamic_array_memory.C.codes.
