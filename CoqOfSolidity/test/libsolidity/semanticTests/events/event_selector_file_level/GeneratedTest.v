...
Require test.libsolidity.semanticTests.events.event_selector_file_level.C.
Require test.libsolidity.semanticTests.events.event_selector_file_level.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_selector_file_level.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_selector_file_level.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_selector_file_level.C.codes.
