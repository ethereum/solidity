...
Require test.libsolidity.semanticTests.events.event_really_lots_of_data.ClientReceipt.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_really_lots_of_data.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_really_lots_of_data.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_really_lots_of_data.ClientReceipt.codes.
