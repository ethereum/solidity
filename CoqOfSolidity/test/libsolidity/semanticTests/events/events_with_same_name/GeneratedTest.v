...
Require test.libsolidity.semanticTests.events.events_with_same_name.ClientReceipt.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.events_with_same_name.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.events_with_same_name.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.events_with_same_name.ClientReceipt.codes.
