...
Require test.libsolidity.semanticTests.events.event_emit_from_a_foreign_contract.C.
Require test.libsolidity.semanticTests.events.event_emit_from_a_foreign_contract.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_emit_from_a_foreign_contract.D.D.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_emit_from_a_foreign_contract.D.D.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_emit_from_a_foreign_contract.D.codes.
