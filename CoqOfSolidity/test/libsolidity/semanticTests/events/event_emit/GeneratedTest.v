...
Require test.libsolidity.semanticTests.events.event_emit.ClientReceipt.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_emit.ClientReceipt.ClientReceipt.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_emit.ClientReceipt.ClientReceipt.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_emit.ClientReceipt.codes.
