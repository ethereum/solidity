...
Require test.libsolidity.semanticTests.events.event_access_through_base_name_emit.A.
Require test.libsolidity.semanticTests.events.event_access_through_base_name_emit.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_access_through_base_name_emit.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_access_through_base_name_emit.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_access_through_base_name_emit.B.codes.
