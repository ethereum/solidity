...
Require test.libsolidity.semanticTests.events.event_indexed_string.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.events.event_indexed_string.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.events.event_indexed_string.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.events.event_indexed_string.C.codes.
...
// gas irOptimized: 332789
// gas legacy: 365828
// gas legacyOptimized: 362250 *)
Module Step1.
  Definition environment : Environment.t :={|
    Environment.caller := 0x1212121212121212121212121212120000000012;
    Environment.callvalue := 0;
