...
Require test.libsolidity.semanticTests.emit_three_identical_events.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.emit_three_identical_events.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.emit_three_identical_events.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.emit_three_identical_events.C.codes.
