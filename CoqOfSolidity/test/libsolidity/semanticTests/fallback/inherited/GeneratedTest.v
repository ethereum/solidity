...
Require test.libsolidity.semanticTests.fallback.inherited.A.
Require test.libsolidity.semanticTests.fallback.inherited.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.fallback.inherited.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.fallback.inherited.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.fallback.inherited.B.codes.
