...
Require test.libsolidity.semanticTests.fallback.falback_return.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.fallback.falback_return.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.fallback.falback_return.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.fallback.falback_return.A.codes.
