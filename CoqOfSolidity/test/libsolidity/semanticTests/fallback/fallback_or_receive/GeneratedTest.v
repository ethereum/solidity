...
Require test.libsolidity.semanticTests.fallback.fallback_or_receive.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.fallback.fallback_or_receive.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.fallback.fallback_or_receive.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.fallback.fallback_or_receive.C.codes.
