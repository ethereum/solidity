...
Require test.libsolidity.semanticTests.fallback.fallback_argument_to_storage.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.fallback.fallback_argument_to_storage.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.fallback.fallback_argument_to_storage.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.fallback.fallback_argument_to_storage.A.codes.
