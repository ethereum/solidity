...
Require test.libsolidity.semanticTests.empty_for_loop.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.empty_for_loop.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.empty_for_loop.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.empty_for_loop.test.codes.
