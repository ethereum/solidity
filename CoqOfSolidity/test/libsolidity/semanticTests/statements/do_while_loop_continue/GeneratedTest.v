...
Require test.libsolidity.semanticTests.statements.do_while_loop_continue.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.statements.do_while_loop_continue.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.statements.do_while_loop_continue.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.statements.do_while_loop_continue.test.codes.
