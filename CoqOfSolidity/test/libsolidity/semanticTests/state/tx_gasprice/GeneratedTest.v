...
Require test.libsolidity.semanticTests.state.tx_gasprice.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state.tx_gasprice.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state.tx_gasprice.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state.tx_gasprice.C.codes.
