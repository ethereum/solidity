...
Require test.libsolidity.semanticTests.state.block_difficulty_post_paris.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state.block_difficulty_post_paris.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state.block_difficulty_post_paris.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state.block_difficulty_post_paris.C.codes.
