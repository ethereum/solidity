...
Require test.libsolidity.semanticTests.state.block_timestamp.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state.block_timestamp.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state.block_timestamp.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state.block_timestamp.C.codes.
