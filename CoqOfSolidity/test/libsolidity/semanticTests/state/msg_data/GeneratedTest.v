...
Require test.libsolidity.semanticTests.state.msg_data.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state.msg_data.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state.msg_data.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.state.msg_data.C.codes.
