...
Require test.libsolidity.semanticTests.state.blobhash.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state.blobhash.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state.blobhash.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state.blobhash.C.codes.
