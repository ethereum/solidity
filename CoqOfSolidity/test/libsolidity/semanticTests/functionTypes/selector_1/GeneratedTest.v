...
Require test.libsolidity.semanticTests.functionTypes.selector_1.B.
Require test.libsolidity.semanticTests.functionTypes.selector_1.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.selector_1.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.selector_1.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.selector_1.C.codes.
