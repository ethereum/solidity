...
Require test.libsolidity.semanticTests.functionTypes.selector_expression_side_effect.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.selector_expression_side_effect.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.selector_expression_side_effect.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.selector_expression_side_effect.C.codes.
