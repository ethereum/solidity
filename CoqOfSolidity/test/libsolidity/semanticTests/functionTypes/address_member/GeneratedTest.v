...
Require test.libsolidity.semanticTests.functionTypes.address_member.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.address_member.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.address_member.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.address_member.C.codes.
