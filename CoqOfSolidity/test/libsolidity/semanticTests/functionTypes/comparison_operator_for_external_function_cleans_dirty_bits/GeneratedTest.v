...
Require test.libsolidity.semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.comparison_operator_for_external_function_cleans_dirty_bits.C.codes.
