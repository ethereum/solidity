...
Require test.libsolidity.semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.same_function_in_construction_and_runtime_equality_check.C.codes.
