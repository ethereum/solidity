...
Require test.libsolidity.semanticTests.functionTypes.store_function.C.
Require test.libsolidity.semanticTests.functionTypes.store_function.Other.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.store_function.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.store_function.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.store_function.C.codes.
