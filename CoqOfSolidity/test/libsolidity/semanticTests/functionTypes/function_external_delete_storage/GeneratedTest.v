...
Require test.libsolidity.semanticTests.functionTypes.function_external_delete_storage.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.function_external_delete_storage.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.function_external_delete_storage.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.functionTypes.function_external_delete_storage.C.codes.
