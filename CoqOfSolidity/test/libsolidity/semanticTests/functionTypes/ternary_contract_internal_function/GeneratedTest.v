...
Require test.libsolidity.semanticTests.functionTypes.ternary_contract_internal_function.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.ternary_contract_internal_function.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.ternary_contract_internal_function.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.ternary_contract_internal_function.C.codes.
