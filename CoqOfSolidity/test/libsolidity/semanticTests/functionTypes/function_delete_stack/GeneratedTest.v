...
Require test.libsolidity.semanticTests.functionTypes.function_delete_stack.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.function_delete_stack.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionTypes.function_delete_stack.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionTypes.function_delete_stack.C.codes.
