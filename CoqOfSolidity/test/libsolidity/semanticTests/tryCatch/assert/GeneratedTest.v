...
Require test.libsolidity.semanticTests.tryCatch.assert.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.assert.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.assert.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.tryCatch.assert.C.codes.
