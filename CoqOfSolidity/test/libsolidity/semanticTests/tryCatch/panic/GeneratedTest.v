...
Require test.libsolidity.semanticTests.tryCatch.panic.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.panic.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.panic.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.tryCatch.panic.C.codes.
