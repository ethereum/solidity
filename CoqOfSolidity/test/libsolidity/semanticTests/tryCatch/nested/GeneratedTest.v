...
Require test.libsolidity.semanticTests.tryCatch.nested.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.nested.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.nested.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.tryCatch.nested.C.codes.
