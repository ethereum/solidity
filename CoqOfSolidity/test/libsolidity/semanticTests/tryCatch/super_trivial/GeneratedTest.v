...
Require test.libsolidity.semanticTests.tryCatch.super_trivial.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.super_trivial.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.tryCatch.super_trivial.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.tryCatch.super_trivial.C.codes.
