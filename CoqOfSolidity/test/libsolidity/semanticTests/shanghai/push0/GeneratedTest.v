...
Require test.libsolidity.semanticTests.shanghai.push0.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.shanghai.push0.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.shanghai.push0.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.shanghai.push0.C.codes.
