...
Require test.libsolidity.semanticTests.smoke.multiline.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.smoke.multiline.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.smoke.multiline.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.smoke.multiline.C.codes.
