...
Require test.libsolidity.semanticTests.smoke.fallback.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.smoke.fallback.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.smoke.fallback.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.smoke.fallback.A.codes.
