...
Require test.libsolidity.semanticTests.smoke.multiline_comments.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.smoke.multiline_comments.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.smoke.multiline_comments.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.smoke.multiline_comments.C.codes.
