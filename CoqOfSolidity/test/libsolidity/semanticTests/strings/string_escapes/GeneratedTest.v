...
Require test.libsolidity.semanticTests.strings.string_escapes.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.strings.string_escapes.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.strings.string_escapes.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.strings.string_escapes.test.codes.
