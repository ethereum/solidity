...
Require test.libsolidity.semanticTests.strings.concat.string_concat_different_types.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.strings.concat.string_concat_different_types.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.strings.concat.string_concat_different_types.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.strings.concat.string_concat_different_types.C.codes.
