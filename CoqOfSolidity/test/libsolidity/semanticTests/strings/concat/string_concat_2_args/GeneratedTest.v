...
Require test.libsolidity.semanticTests.strings.concat.string_concat_2_args.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.strings.concat.string_concat_2_args.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.strings.concat.string_concat_2_args.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.strings.concat.string_concat_2_args.C.codes.
