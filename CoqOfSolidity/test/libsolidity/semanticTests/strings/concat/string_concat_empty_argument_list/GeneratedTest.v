...
Require test.libsolidity.semanticTests.strings.concat.string_concat_empty_argument_list.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.strings.concat.string_concat_empty_argument_list.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.strings.concat.string_concat_empty_argument_list.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.strings.concat.string_concat_empty_argument_list.C.codes.
