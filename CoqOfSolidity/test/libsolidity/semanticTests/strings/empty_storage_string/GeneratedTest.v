...
Require test.libsolidity.semanticTests.strings.empty_storage_string.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.strings.empty_storage_string.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.strings.empty_storage_string.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.strings.empty_storage_string.C.codes.
