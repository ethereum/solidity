...
Require test.libsolidity.semanticTests.structs.lone_struct_array_type.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.lone_struct_array_type.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.lone_struct_array_type.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.lone_struct_array_type.C.codes.
