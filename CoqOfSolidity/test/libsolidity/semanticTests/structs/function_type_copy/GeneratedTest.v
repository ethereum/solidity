...
Require test.libsolidity.semanticTests.structs.function_type_copy.C.
Require test.libsolidity.semanticTests.structs.function_type_copy.Test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.function_type_copy.Test.Test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.function_type_copy.Test.Test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.function_type_copy.Test.codes.
