...
Require test.libsolidity.semanticTests.structs.calldata.calldata_struct_and_ints.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.calldata.calldata_struct_and_ints.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.calldata.calldata_struct_and_ints.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.calldata.calldata_struct_and_ints.C.codes.
