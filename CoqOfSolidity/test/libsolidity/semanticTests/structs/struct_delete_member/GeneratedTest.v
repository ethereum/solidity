...
Require test.libsolidity.semanticTests.structs.struct_delete_member.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_delete_member.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_delete_member.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.struct_delete_member.test.codes.
