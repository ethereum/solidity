...
Require test.libsolidity.semanticTests.structs.recursive_structs.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.recursive_structs.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.recursive_structs.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.recursive_structs.C.codes.
