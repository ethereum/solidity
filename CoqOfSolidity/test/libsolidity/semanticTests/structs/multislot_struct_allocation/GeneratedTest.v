...
Require test.libsolidity.semanticTests.structs.multislot_struct_allocation.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.multislot_struct_allocation.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.multislot_struct_allocation.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.multislot_struct_allocation.C.codes.
