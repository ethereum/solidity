...
Require test.libsolidity.semanticTests.structs.memory_struct_named_constructor.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.memory_struct_named_constructor.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.memory_struct_named_constructor.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.memory_struct_named_constructor.C.codes.
