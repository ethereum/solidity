...
Require test.libsolidity.semanticTests.structs.struct_reference.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_reference.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_reference.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.struct_reference.test.codes.
