...
Require test.libsolidity.semanticTests.structs.struct_copy_via_local.c.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_copy_via_local.c.c.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_copy_via_local.c.c.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.struct_copy_via_local.c.codes.
