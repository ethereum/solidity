...
Require test.libsolidity.semanticTests.structs.packed_storage_structs_delete.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.packed_storage_structs_delete.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.packed_storage_structs_delete.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.packed_storage_structs_delete.C.codes.
