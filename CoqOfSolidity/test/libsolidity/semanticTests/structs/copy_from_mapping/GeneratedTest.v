...
Require test.libsolidity.semanticTests.structs.copy_from_mapping.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.copy_from_mapping.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.copy_from_mapping.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.copy_from_mapping.C.codes.
