...
Require test.libsolidity.semanticTests.structs.struct_delete_storage_small.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_delete_storage_small.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_delete_storage_small.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.struct_delete_storage_small.C.codes.
