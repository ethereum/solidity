...
Require test.libsolidity.semanticTests.structs.struct_storage_to_mapping.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_storage_to_mapping.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.structs.struct_storage_to_mapping.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.structs.struct_storage_to_mapping.C.codes.
