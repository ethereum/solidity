...
Require test.libsolidity.semanticTests.operators.userDefined.checked_operators.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.checked_operators.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.checked_operators.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.userDefined.checked_operators.C.codes.
