...
Require test.libsolidity.semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.userDefined.operator_definition_shadowing_builtin_keccak256.C.codes.
