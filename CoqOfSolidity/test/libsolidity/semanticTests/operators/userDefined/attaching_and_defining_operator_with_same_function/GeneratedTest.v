...
Require test.libsolidity.semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.userDefined.attaching_and_defining_operator_with_same_function.C.codes.
