...
Require test.libsolidity.semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.userDefined.multiple_operator_definitions_same_type_same_function_same_directive.C.codes.
