...
Require test.libsolidity.semanticTests.operators.shifts.shift_overflow.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.shift_overflow.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.shift_overflow.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.shifts.shift_overflow.C.codes.
