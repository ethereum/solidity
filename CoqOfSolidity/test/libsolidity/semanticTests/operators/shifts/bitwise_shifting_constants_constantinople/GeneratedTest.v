...
Require test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constants_constantinople.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constants_constantinople.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constants_constantinople.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constants_constantinople.C.codes.
