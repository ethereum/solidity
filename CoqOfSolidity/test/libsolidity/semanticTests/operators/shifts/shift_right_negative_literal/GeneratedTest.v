...
Require test.libsolidity.semanticTests.operators.shifts.shift_right_negative_literal.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.shift_right_negative_literal.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.shift_right_negative_literal.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.shifts.shift_right_negative_literal.C.codes.
