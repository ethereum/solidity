...
Require test.libsolidity.semanticTests.operators.shifts.shift_left_larger_type.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.shift_left_larger_type.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.shift_left_larger_type.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.operators.shifts.shift_left_larger_type.C.codes.
