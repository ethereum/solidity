...
Require test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constantinople_combined.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constantinople_combined.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constantinople_combined.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.operators.shifts.bitwise_shifting_constantinople_combined.C.codes.
