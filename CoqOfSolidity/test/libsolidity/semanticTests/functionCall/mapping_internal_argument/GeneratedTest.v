...
Require test.libsolidity.semanticTests.functionCall.mapping_internal_argument.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.mapping_internal_argument.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.mapping_internal_argument.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.mapping_internal_argument.test.codes.
