...
Require test.libsolidity.semanticTests.functionCall.named_args_overload.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.named_args_overload.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.named_args_overload.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.named_args_overload.C.codes.
