...
Require test.libsolidity.semanticTests.functionCall.transaction_status.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.transaction_status.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.transaction_status.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.transaction_status.test.codes.
