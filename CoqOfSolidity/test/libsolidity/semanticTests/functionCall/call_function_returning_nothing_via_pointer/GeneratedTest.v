...
Require test.libsolidity.semanticTests.functionCall.call_function_returning_nothing_via_pointer.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.call_function_returning_nothing_via_pointer.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.call_function_returning_nothing_via_pointer.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.call_function_returning_nothing_via_pointer.test.codes.
