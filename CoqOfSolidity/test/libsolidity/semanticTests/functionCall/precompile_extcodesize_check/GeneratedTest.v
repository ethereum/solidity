...
Require test.libsolidity.semanticTests.functionCall.precompile_extcodesize_check.C.
Require test.libsolidity.semanticTests.functionCall.precompile_extcodesize_check.Identity.
Require test.libsolidity.semanticTests.functionCall.precompile_extcodesize_check.ReturnMoreData.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.precompile_extcodesize_check.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.precompile_extcodesize_check.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.precompile_extcodesize_check.C.codes.
