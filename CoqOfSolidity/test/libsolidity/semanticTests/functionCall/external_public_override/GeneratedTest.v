...
Require test.libsolidity.semanticTests.functionCall.external_public_override.A.
Require test.libsolidity.semanticTests.functionCall.external_public_override.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.external_public_override.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.external_public_override.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.external_public_override.B.codes.
