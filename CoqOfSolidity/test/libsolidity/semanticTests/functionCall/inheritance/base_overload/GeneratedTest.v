...
Require test.libsolidity.semanticTests.functionCall.inheritance.base_overload.Base.
Require test.libsolidity.semanticTests.functionCall.inheritance.base_overload.Child.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.inheritance.base_overload.Child.Child.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.inheritance.base_overload.Child.Child.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.inheritance.base_overload.Child.codes.
