...
Require test.libsolidity.semanticTests.functionCall.bare_call_no_returndatacopy.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.bare_call_no_returndatacopy.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.bare_call_no_returndatacopy.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.bare_call_no_returndatacopy.C.codes.
