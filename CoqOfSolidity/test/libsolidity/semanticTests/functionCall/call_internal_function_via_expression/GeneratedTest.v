...
Require test.libsolidity.semanticTests.functionCall.call_internal_function_via_expression.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.call_internal_function_via_expression.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.call_internal_function_via_expression.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.call_internal_function_via_expression.C.codes.
