...
Require test.libsolidity.semanticTests.functionCall.calling_nonexisting_contract_throws.C.
Require test.libsolidity.semanticTests.functionCall.calling_nonexisting_contract_throws.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.calling_nonexisting_contract_throws.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.calling_nonexisting_contract_throws.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.calling_nonexisting_contract_throws.C.codes.
