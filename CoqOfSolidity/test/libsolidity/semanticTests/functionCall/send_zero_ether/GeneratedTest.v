...
Require test.libsolidity.semanticTests.functionCall.send_zero_ether.Main.
Require test.libsolidity.semanticTests.functionCall.send_zero_ether.Receiver.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.send_zero_ether.Main.Main.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.send_zero_ether.Main.Main.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.send_zero_ether.Main.codes.
