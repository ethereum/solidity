...
Require test.libsolidity.semanticTests.functionCall.failed_create.C.
Require test.libsolidity.semanticTests.functionCall.failed_create.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.failed_create.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.failed_create.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.functionCall.failed_create.C.codes.
