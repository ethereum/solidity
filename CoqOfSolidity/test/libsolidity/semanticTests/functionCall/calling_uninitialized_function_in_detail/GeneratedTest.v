...
Require test.libsolidity.semanticTests.functionCall.calling_uninitialized_function_in_detail.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.calling_uninitialized_function_in_detail.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.calling_uninitialized_function_in_detail.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.calling_uninitialized_function_in_detail.C.codes.
