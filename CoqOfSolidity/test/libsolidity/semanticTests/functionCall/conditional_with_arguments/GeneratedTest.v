...
Require test.libsolidity.semanticTests.functionCall.conditional_with_arguments.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.conditional_with_arguments.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.conditional_with_arguments.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.conditional_with_arguments.C.codes.
