...
Require test.libsolidity.semanticTests.functionCall.external_call_to_nonexisting.C.
Require test.libsolidity.semanticTests.functionCall.external_call_to_nonexisting.I.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.external_call_to_nonexisting.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.external_call_to_nonexisting.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.external_call_to_nonexisting.C.codes.
