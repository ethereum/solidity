...
Require test.libsolidity.semanticTests.functionCall.creation_function_call_no_args.C.
Require test.libsolidity.semanticTests.functionCall.creation_function_call_no_args.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.creation_function_call_no_args.D.D.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.creation_function_call_no_args.D.D.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.creation_function_call_no_args.D.codes.
