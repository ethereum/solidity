...
Require test.libsolidity.semanticTests.functionCall.gas_and_value_basic.helper.
Require test.libsolidity.semanticTests.functionCall.gas_and_value_basic.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.gas_and_value_basic.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.gas_and_value_basic.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.gas_and_value_basic.test.codes.
