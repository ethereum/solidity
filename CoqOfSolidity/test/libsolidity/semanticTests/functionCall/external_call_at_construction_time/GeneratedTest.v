...
Require test.libsolidity.semanticTests.functionCall.external_call_at_construction_time.C.
Require test.libsolidity.semanticTests.functionCall.external_call_at_construction_time.T.
Require test.libsolidity.semanticTests.functionCall.external_call_at_construction_time.U.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.external_call_at_construction_time.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.external_call_at_construction_time.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.external_call_at_construction_time.C.codes.
