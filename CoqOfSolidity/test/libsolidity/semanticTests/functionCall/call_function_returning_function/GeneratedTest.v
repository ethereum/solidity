...
Require test.libsolidity.semanticTests.functionCall.call_function_returning_function.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.call_function_returning_function.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.functionCall.call_function_returning_function.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.functionCall.call_function_returning_function.test.codes.
