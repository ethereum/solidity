...
Require test.libsolidity.semanticTests.interfaceID.interfaceId_events.HelloWorld.
Require test.libsolidity.semanticTests.interfaceID.interfaceId_events.HelloWorldWithEvent.
Require test.libsolidity.semanticTests.interfaceID.interfaceId_events.Test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.interfaceId_events.Test.Test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.interfaceId_events.Test.Test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.interfaceID.interfaceId_events.Test.codes.
