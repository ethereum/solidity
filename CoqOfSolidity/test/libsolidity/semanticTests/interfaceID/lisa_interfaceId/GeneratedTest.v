...
Require test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.ERC165.
Require test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.ERC165MappingImplementation.
Require test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.Lisa.
Require test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.Simpson.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.Lisa.Lisa.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.Lisa.Lisa.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.interfaceID.lisa_interfaceId.Lisa.codes.
