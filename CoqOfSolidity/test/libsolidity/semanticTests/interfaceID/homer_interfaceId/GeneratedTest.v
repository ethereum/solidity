...
Require test.libsolidity.semanticTests.interfaceID.homer_interfaceId.ERC165.
Require test.libsolidity.semanticTests.interfaceID.homer_interfaceId.Homer.
Require test.libsolidity.semanticTests.interfaceID.homer_interfaceId.Simpson.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.homer_interfaceId.Homer.Homer.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.homer_interfaceId.Homer.Homer.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.interfaceID.homer_interfaceId.Homer.codes.
