...
Require test.libsolidity.semanticTests.interfaceID.homer.ERC165.
Require test.libsolidity.semanticTests.interfaceID.homer.Homer.
Require test.libsolidity.semanticTests.interfaceID.homer.Simpson.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.homer.Homer.Homer.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.homer.Homer.Homer.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.interfaceID.homer.Homer.codes.
