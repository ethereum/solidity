...
Require test.libsolidity.semanticTests.interfaceID.lisa.ERC165.
Require test.libsolidity.semanticTests.interfaceID.lisa.ERC165MappingImplementation.
Require test.libsolidity.semanticTests.interfaceID.lisa.Lisa.
Require test.libsolidity.semanticTests.interfaceID.lisa.Simpson.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.lisa.Lisa.Lisa.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.interfaceID.lisa.Lisa.Lisa.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.interfaceID.lisa.Lisa.codes.
