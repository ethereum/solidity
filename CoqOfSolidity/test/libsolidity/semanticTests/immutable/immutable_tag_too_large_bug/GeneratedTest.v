...
Require test.libsolidity.semanticTests.immutable.immutable_tag_too_large_bug.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.immutable_tag_too_large_bug.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.immutable_tag_too_large_bug.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.immutable.immutable_tag_too_large_bug.C.codes.
