...
Require test.libsolidity.semanticTests.immutable.assign_at_declaration.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.assign_at_declaration.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.assign_at_declaration.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.assign_at_declaration.A.codes.
