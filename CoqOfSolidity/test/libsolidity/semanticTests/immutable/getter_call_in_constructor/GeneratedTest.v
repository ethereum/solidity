...
Require test.libsolidity.semanticTests.immutable.getter_call_in_constructor.A.
Require test.libsolidity.semanticTests.immutable.getter_call_in_constructor.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.getter_call_in_constructor.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.getter_call_in_constructor.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.getter_call_in_constructor.C.codes.
