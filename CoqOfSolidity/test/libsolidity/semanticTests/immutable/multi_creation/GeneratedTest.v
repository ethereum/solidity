...
Require test.libsolidity.semanticTests.immutable.multi_creation.A.
Require test.libsolidity.semanticTests.immutable.multi_creation.B.
Require test.libsolidity.semanticTests.immutable.multi_creation.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.multi_creation.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.multi_creation.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.multi_creation.C.codes.
