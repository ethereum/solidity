...
Require test.libsolidity.semanticTests.immutable.delete.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.delete.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.delete.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.delete.C.codes.
