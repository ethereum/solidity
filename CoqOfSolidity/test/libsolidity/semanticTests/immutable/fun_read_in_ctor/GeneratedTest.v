...
Require test.libsolidity.semanticTests.immutable.fun_read_in_ctor.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.fun_read_in_ctor.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.fun_read_in_ctor.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.fun_read_in_ctor.A.codes.
