...
Require test.libsolidity.semanticTests.immutable.assign_from_immutables.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.assign_from_immutables.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.assign_from_immutables.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.assign_from_immutables.C.codes.
