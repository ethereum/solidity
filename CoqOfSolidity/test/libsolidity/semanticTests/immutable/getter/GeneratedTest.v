...
Require test.libsolidity.semanticTests.immutable.getter.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.getter.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.getter.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.getter.C.codes.
