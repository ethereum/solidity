...
Require test.libsolidity.semanticTests.immutable.multiple_initializations.A.
Require test.libsolidity.semanticTests.immutable.multiple_initializations.B.
Require test.libsolidity.semanticTests.immutable.multiple_initializations.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.immutable.multiple_initializations.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.immutable.multiple_initializations.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.immutable.multiple_initializations.C.codes.
