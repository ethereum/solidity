...
Require test.libsolidity.semanticTests.empty_contract.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.empty_contract.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.empty_contract.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.empty_contract.test.codes.
