...
Require test.libsolidity.semanticTests.getters.mapping_with_names.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.getters.mapping_with_names.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.getters.mapping_with_names.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.getters.mapping_with_names.C.codes.
