...
Require test.libsolidity.semanticTests.getters.arrays.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.getters.arrays.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.getters.arrays.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.getters.arrays.C.codes.
