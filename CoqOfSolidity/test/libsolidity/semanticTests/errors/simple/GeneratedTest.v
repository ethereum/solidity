...
Require test.libsolidity.semanticTests.errors.simple.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.simple.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.simple.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.errors.simple.C.codes.
