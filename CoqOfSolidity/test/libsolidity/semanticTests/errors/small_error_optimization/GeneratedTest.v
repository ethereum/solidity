...
Require test.libsolidity.semanticTests.errors.small_error_optimization.A.
Require test.libsolidity.semanticTests.errors.small_error_optimization.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.small_error_optimization.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.small_error_optimization.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.errors.small_error_optimization.B.codes.
