...
Require test.libsolidity.semanticTests.errors.require_error_evaluation_order_2.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_error_evaluation_order_2.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_error_evaluation_order_2.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.errors.require_error_evaluation_order_2.C.codes.
