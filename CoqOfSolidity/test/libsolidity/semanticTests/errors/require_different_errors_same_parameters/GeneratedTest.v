...
Require test.libsolidity.semanticTests.errors.require_different_errors_same_parameters.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_different_errors_same_parameters.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_different_errors_same_parameters.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.errors.require_different_errors_same_parameters.C.codes.
