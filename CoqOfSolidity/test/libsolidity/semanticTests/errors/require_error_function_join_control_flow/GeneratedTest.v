...
Require test.libsolidity.semanticTests.errors.require_error_function_join_control_flow.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_error_function_join_control_flow.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_error_function_join_control_flow.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.errors.require_error_function_join_control_flow.C.codes.
