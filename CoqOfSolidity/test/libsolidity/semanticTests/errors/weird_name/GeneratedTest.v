...
Require test.libsolidity.semanticTests.errors.weird_name.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.weird_name.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.weird_name.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.errors.weird_name.C.codes.
