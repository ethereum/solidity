...
Require test.libsolidity.semanticTests.errors.require_error_condition_evaluated_only_once.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_error_condition_evaluated_only_once.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.errors.require_error_condition_evaluated_only_once.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.errors.require_error_condition_evaluated_only_once.C.codes.
