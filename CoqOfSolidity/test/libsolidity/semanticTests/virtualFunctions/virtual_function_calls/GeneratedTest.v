...
Require test.libsolidity.semanticTests.virtualFunctions.virtual_function_calls.Base.
Require test.libsolidity.semanticTests.virtualFunctions.virtual_function_calls.Derived.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.virtualFunctions.virtual_function_calls.Derived.Derived.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.virtualFunctions.virtual_function_calls.Derived.Derived.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.virtualFunctions.virtual_function_calls.Derived.codes.
