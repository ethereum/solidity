...
Require test.libsolidity.semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.keccak256_optimizer_bug_different_memory_location.C.codes.
