...
Require test.libsolidity.semanticTests.inlineAssembly.inlineasm_empty_let.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inlineasm_empty_let.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inlineasm_empty_let.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.inlineasm_empty_let.C.codes.
