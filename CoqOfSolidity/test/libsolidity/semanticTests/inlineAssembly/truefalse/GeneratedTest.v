...
Require test.libsolidity.semanticTests.inlineAssembly.truefalse.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.truefalse.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.truefalse.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.truefalse.C.codes.
