...
Require test.libsolidity.semanticTests.inlineAssembly.transient_storage_low_level_calls.C.
Require test.libsolidity.semanticTests.inlineAssembly.transient_storage_low_level_calls.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_low_level_calls.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_low_level_calls.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_low_level_calls.C.codes.
