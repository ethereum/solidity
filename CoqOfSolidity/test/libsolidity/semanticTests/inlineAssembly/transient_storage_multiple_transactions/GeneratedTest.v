...
Require test.libsolidity.semanticTests.inlineAssembly.transient_storage_multiple_transactions.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_multiple_transactions.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_multiple_transactions.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_multiple_transactions.C.codes.
