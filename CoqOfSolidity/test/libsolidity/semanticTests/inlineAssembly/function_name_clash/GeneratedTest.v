...
Require test.libsolidity.semanticTests.inlineAssembly.function_name_clash.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.function_name_clash.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.function_name_clash.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.function_name_clash.C.codes.
