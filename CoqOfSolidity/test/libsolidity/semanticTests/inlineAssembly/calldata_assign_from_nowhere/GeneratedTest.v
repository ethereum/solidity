...
Require test.libsolidity.semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.calldata_assign_from_nowhere.C.codes.
