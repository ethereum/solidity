...
Require test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_via_pointer.C.codes.
