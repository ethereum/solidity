...
Require test.libsolidity.semanticTests.inlineAssembly.keccak_yul_optimization.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.keccak_yul_optimization.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.keccak_yul_optimization.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.keccak_yul_optimization.C.codes.
