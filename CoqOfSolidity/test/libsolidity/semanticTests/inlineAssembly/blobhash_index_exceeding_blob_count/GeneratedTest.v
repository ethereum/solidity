...
Require test.libsolidity.semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.blobhash_index_exceeding_blob_count.C.codes.
