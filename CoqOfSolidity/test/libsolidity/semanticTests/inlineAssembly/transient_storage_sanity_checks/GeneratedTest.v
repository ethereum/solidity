...
Require test.libsolidity.semanticTests.inlineAssembly.transient_storage_sanity_checks.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_sanity_checks.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_sanity_checks.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_sanity_checks.C.codes.
