...
Require test.libsolidity.semanticTests.inlineAssembly.prevrandao.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.prevrandao.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.prevrandao.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.prevrandao.C.codes.
