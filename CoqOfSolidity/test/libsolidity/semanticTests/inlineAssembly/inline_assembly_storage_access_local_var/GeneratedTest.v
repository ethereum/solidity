...
Require test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access_local_var.C.codes.
