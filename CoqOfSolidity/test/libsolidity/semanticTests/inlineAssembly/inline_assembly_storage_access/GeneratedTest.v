...
Require test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_storage_access.C.codes.
