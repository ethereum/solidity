...
Require test.libsolidity.semanticTests.inlineAssembly.inline_assembly_recursion.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_recursion.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_recursion.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.inline_assembly_recursion.C.codes.
