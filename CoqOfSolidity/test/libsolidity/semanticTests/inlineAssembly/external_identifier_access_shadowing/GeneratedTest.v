...
Require test.libsolidity.semanticTests.inlineAssembly.external_identifier_access_shadowing.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.external_identifier_access_shadowing.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.external_identifier_access_shadowing.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.external_identifier_access_shadowing.C.codes.
