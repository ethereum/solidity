...
Require test.libsolidity.semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.inlineAssembly.transient_storage_simple_reentrancy_lock.C.codes.
