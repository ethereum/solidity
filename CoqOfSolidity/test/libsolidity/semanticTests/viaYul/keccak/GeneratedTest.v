...
Require test.libsolidity.semanticTests.viaYul.keccak.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.keccak.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.keccak.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.viaYul.keccak.C.codes.
