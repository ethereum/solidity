...
Require test.libsolidity.semanticTests.viaYul.conversion.function_cast.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.conversion.function_cast.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.conversion.function_cast.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.conversion.function_cast.C.codes.
