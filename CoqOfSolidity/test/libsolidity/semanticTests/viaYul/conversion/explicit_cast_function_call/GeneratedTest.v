...
Require test.libsolidity.semanticTests.viaYul.conversion.explicit_cast_function_call.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.conversion.explicit_cast_function_call.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.conversion.explicit_cast_function_call.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.conversion.explicit_cast_function_call.C.codes.
