...
Require test.libsolidity.semanticTests.viaYul.assert.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.assert.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.assert.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.assert.C.codes.
