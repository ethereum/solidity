...
Require test.libsolidity.semanticTests.viaYul.cleanup.checked_arithmetic.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.cleanup.checked_arithmetic.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.cleanup.checked_arithmetic.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.viaYul.cleanup.checked_arithmetic.C.codes.
