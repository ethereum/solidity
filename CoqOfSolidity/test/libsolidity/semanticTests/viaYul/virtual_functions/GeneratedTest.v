...
Require test.libsolidity.semanticTests.viaYul.virtual_functions.C.
Require test.libsolidity.semanticTests.viaYul.virtual_functions.X.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.virtual_functions.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.virtual_functions.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.virtual_functions.C.codes.
