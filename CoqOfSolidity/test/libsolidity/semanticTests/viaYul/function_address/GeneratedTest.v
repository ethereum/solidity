...
Require test.libsolidity.semanticTests.viaYul.function_address.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.function_address.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.function_address.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.function_address.C.codes.
