...
Require test.libsolidity.semanticTests.viaYul.detect_mul_overflow_signed.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.detect_mul_overflow_signed.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.detect_mul_overflow_signed.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.viaYul.detect_mul_overflow_signed.C.codes.
