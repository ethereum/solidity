...
Require test.libsolidity.semanticTests.viaYul.conditional.conditional_true_false_literal.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.conditional.conditional_true_false_literal.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.conditional.conditional_true_false_literal.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.conditional.conditional_true_false_literal.A.codes.
