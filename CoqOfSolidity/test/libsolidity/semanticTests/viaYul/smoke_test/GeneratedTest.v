...
Require test.libsolidity.semanticTests.viaYul.smoke_test.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.smoke_test.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.smoke_test.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.smoke_test.C.codes.
