...
Require test.libsolidity.semanticTests.viaYul.return.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.return.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.return.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.return.C.codes.
