...
Require test.libsolidity.semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.empty_return_corrupted_free_memory_pointer.C.codes.
