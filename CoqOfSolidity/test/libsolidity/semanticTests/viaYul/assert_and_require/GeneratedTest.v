...
Require test.libsolidity.semanticTests.viaYul.assert_and_require.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.assert_and_require.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.assert_and_require.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.assert_and_require.C.codes.
