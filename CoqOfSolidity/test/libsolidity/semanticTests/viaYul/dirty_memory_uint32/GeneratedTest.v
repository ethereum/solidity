...
Require test.libsolidity.semanticTests.viaYul.dirty_memory_uint32.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.dirty_memory_uint32.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.dirty_memory_uint32.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.dirty_memory_uint32.C.codes.
