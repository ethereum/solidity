...
Require test.libsolidity.semanticTests.viaYul.memory_struct_allow.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.memory_struct_allow.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.memory_struct_allow.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.memory_struct_allow.C.codes.
