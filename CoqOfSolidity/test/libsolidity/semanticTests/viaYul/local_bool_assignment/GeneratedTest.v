...
Require test.libsolidity.semanticTests.viaYul.local_bool_assignment.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.local_bool_assignment.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.local_bool_assignment.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.local_bool_assignment.C.codes.
