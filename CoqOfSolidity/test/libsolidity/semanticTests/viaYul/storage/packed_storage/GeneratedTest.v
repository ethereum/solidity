...
Require test.libsolidity.semanticTests.viaYul.storage.packed_storage.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.storage.packed_storage.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.storage.packed_storage.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.storage.packed_storage.C.codes.
