...
Require test.libsolidity.semanticTests.viaYul.tuple_evaluation_order.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.tuple_evaluation_order.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.tuple_evaluation_order.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.tuple_evaluation_order.C.codes.
