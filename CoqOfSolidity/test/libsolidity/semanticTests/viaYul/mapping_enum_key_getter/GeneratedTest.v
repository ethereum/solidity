...
Require test.libsolidity.semanticTests.viaYul.mapping_enum_key_getter.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.mapping_enum_key_getter.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.mapping_enum_key_getter.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.mapping_enum_key_getter.test.codes.
