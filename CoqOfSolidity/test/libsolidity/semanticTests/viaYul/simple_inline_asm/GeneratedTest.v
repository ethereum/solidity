...
Require test.libsolidity.semanticTests.viaYul.simple_inline_asm.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.simple_inline_asm.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.simple_inline_asm.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.simple_inline_asm.C.codes.
