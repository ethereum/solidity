...
Require test.libsolidity.semanticTests.viaYul.return_storage_pointers.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.return_storage_pointers.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.return_storage_pointers.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.return_storage_pointers.C.codes.
