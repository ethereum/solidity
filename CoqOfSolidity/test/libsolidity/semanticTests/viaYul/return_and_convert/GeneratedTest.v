...
Require test.libsolidity.semanticTests.viaYul.return_and_convert.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.return_and_convert.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.return_and_convert.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.return_and_convert.C.codes.
