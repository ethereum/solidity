...
Require test.libsolidity.semanticTests.viaYul.string_format.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.string_format.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.string_format.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.viaYul.string_format.C.codes.
