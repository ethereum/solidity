...
Require test.libsolidity.semanticTests.viaYul.mapping_getters.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.mapping_getters.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.mapping_getters.test.test.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.viaYul.mapping_getters.test.codes.
