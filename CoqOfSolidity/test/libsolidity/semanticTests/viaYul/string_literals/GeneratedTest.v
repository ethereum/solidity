...
Require test.libsolidity.semanticTests.viaYul.string_literals.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.string_literals.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.string_literals.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.string_literals.C.codes.
