...
Require test.libsolidity.semanticTests.viaYul.unary_fixedbytes.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.unary_fixedbytes.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.unary_fixedbytes.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.unary_fixedbytes.C.codes.
