...
Require test.libsolidity.semanticTests.viaYul.function_entry_checks.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.function_entry_checks.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.function_entry_checks.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.function_entry_checks.C.codes.
