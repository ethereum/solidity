...
Require test.libsolidity.semanticTests.viaYul.exp_literals_success.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.exp_literals_success.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.exp_literals_success.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.viaYul.exp_literals_success.C.codes.
