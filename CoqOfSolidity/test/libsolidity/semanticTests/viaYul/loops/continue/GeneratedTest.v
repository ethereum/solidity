...
Require test.libsolidity.semanticTests.viaYul.loops.continue.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.loops.continue.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.viaYul.loops.continue.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.viaYul.loops.continue.C.codes.
