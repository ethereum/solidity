...
Require test.libsolidity.semanticTests.uninitializedFunctionPointer.store2.InvalidTest.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.store2.InvalidTest.InvalidTest.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.store2.InvalidTest.InvalidTest.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.store2.InvalidTest.codes.
