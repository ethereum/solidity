...
Require test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidStoredInConstructor.C.
Require test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidStoredInConstructor.Test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidStoredInConstructor.Test.Test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidStoredInConstructor.Test.Test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidStoredInConstructor.Test.codes.
