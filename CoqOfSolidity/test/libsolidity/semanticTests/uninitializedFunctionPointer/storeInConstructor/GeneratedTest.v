...
Require test.libsolidity.semanticTests.uninitializedFunctionPointer.storeInConstructor.InvalidTest.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.storeInConstructor.InvalidTest.InvalidTest.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.storeInConstructor.InvalidTest.InvalidTest.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.storeInConstructor.InvalidTest.codes.
