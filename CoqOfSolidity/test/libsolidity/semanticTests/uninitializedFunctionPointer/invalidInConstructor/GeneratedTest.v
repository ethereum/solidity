...
Require test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidInConstructor.C.
Require test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidInConstructor.Test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidInConstructor.Test.Test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidInConstructor.Test.Test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.uninitializedFunctionPointer.invalidInConstructor.Test.codes.
