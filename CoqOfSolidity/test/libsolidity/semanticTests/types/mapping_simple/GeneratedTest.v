...
Require test.libsolidity.semanticTests.types.mapping_simple.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.types.mapping_simple.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.types.mapping_simple.test.test.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.types.mapping_simple.test.codes.
