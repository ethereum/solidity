...
Require test.libsolidity.semanticTests.types.packing_unpacking_types.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.types.packing_unpacking_types.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.types.packing_unpacking_types.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.types.packing_unpacking_types.test.codes.
