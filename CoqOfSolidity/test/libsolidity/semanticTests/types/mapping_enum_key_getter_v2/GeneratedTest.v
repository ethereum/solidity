...
Require test.libsolidity.semanticTests.types.mapping_enum_key_getter_v2.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.types.mapping_enum_key_getter_v2.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.types.mapping_enum_key_getter_v2.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.types.mapping_enum_key_getter_v2.test.codes.
