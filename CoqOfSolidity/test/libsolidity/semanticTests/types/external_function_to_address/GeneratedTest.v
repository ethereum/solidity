...
Require test.libsolidity.semanticTests.types.external_function_to_address.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.types.external_function_to_address.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.types.external_function_to_address.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.types.external_function_to_address.C.codes.
