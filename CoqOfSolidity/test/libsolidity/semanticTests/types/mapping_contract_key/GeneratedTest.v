...
Require test.libsolidity.semanticTests.types.mapping_contract_key.A.
Require test.libsolidity.semanticTests.types.mapping_contract_key.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.types.mapping_contract_key.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.types.mapping_contract_key.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.types.mapping_contract_key.test.codes.
