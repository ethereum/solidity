...
Require test.libsolidity.semanticTests.types.nested_tuples.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.types.nested_tuples.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.types.nested_tuples.test.test.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.types.nested_tuples.test.codes.
