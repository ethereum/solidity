...
Require test.libsolidity.semanticTests.calldata.calldata_struct_cleaning.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_struct_cleaning.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_struct_cleaning.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.calldata.calldata_struct_cleaning.C.codes.
