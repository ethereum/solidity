...
Require test.libsolidity.semanticTests.calldata.calldata_memory_mixed.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_memory_mixed.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_memory_mixed.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.calldata.calldata_memory_mixed.C.codes.
