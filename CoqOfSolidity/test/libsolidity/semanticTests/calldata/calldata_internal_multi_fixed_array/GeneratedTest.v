...
Require test.libsolidity.semanticTests.calldata.calldata_internal_multi_fixed_array.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_internal_multi_fixed_array.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_internal_multi_fixed_array.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.calldata.calldata_internal_multi_fixed_array.C.codes.
