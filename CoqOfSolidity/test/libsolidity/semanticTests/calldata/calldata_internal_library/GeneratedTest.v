...
Require test.libsolidity.semanticTests.calldata.calldata_internal_library.C.
Require test.libsolidity.semanticTests.calldata.calldata_internal_library.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_internal_library.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.calldata.calldata_internal_library.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.calldata.calldata_internal_library.C.codes.
