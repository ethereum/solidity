...
Require test.libsolidity.semanticTests.receive.inherited.A.
Require test.libsolidity.semanticTests.receive.inherited.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.receive.inherited.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.receive.inherited.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.receive.inherited.B.codes.
