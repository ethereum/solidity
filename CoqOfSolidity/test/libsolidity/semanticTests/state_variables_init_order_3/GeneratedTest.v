...
Require test.libsolidity.semanticTests.state_variables_init_order_3.A.
Require test.libsolidity.semanticTests.state_variables_init_order_3.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state_variables_init_order_3.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state_variables_init_order_3.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state_variables_init_order_3.B.codes.
