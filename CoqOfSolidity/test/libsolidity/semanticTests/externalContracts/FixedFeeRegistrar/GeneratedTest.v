...
Require test.libsolidity.semanticTests.externalContracts.FixedFeeRegistrar.FixedFeeRegistrar.
Require test.libsolidity.semanticTests.externalContracts.FixedFeeRegistrar.Registrar.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.externalContracts.FixedFeeRegistrar.FixedFeeRegistrar.FixedFeeRegistrar.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.externalContracts.FixedFeeRegistrar.FixedFeeRegistrar.FixedFeeRegistrar.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.externalContracts.FixedFeeRegistrar.FixedFeeRegistrar.codes.
