...
Require test.libsolidity.semanticTests.isoltestTesting.account.AccountBuiltinTest.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.isoltestTesting.account.AccountBuiltinTest.AccountBuiltinTest.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.isoltestTesting.account.AccountBuiltinTest.AccountBuiltinTest.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.isoltestTesting.account.AccountBuiltinTest.codes.
