...
Require test.libsolidity.semanticTests.variables.delete_local.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.variables.delete_local.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.variables.delete_local.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.variables.delete_local.test.codes.
