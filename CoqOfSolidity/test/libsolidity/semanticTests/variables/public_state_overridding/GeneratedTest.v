...
Require test.libsolidity.semanticTests.variables.public_state_overridding.A.
Require test.libsolidity.semanticTests.variables.public_state_overridding.X.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.variables.public_state_overridding.X.X.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.variables.public_state_overridding.X.X.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.variables.public_state_overridding.X.codes.
