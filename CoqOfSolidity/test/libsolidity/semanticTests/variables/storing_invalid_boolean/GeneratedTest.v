...
Require test.libsolidity.semanticTests.variables.storing_invalid_boolean.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.variables.storing_invalid_boolean.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.variables.storing_invalid_boolean.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.variables.storing_invalid_boolean.C.codes.
