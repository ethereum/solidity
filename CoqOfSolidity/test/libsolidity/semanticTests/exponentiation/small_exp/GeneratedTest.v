...
Require test.libsolidity.semanticTests.exponentiation.small_exp.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.exponentiation.small_exp.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.exponentiation.small_exp.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.exponentiation.small_exp.test.codes.
