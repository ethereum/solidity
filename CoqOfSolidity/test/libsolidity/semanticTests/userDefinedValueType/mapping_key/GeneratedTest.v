...
Require test.libsolidity.semanticTests.userDefinedValueType.mapping_key.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.mapping_key.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.mapping_key.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.userDefinedValueType.mapping_key.C.codes.
