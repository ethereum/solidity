...
Require test.libsolidity.semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_userdefined.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_userdefined.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_userdefined.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.zero_cost_abstraction_comparison_userdefined.C.codes.
