...
Require test.libsolidity.semanticTests.userDefinedValueType.constant.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.constant.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.constant.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.userDefinedValueType.constant.C.codes.
