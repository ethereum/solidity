...
Require test.libsolidity.semanticTests.userDefinedValueType.dirty_uint8_read.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.dirty_uint8_read.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.userDefinedValueType.dirty_uint8_read.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.userDefinedValueType.dirty_uint8_read.C.codes.
