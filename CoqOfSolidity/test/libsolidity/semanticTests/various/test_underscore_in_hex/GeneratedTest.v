...
Require test.libsolidity.semanticTests.various.test_underscore_in_hex.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.test_underscore_in_hex.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.test_underscore_in_hex.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.test_underscore_in_hex.test.codes.
