...
Require test.libsolidity.semanticTests.various.codehash_assembly.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.codehash_assembly.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.codehash_assembly.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.codehash_assembly.C.codes.
