...
Require test.libsolidity.semanticTests.various.empty_name_return_parameter.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.empty_name_return_parameter.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.empty_name_return_parameter.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.empty_name_return_parameter.test.codes.
