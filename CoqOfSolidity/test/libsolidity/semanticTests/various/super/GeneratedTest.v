...
Require test.libsolidity.semanticTests.various.super.A.
Require test.libsolidity.semanticTests.various.super.B.
Require test.libsolidity.semanticTests.various.super.C.
Require test.libsolidity.semanticTests.various.super.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.super.D.D.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.super.D.D.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.super.D.codes.
