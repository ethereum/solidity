...
Require test.libsolidity.semanticTests.various.inline_tuple_with_rational_numbers.c.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.inline_tuple_with_rational_numbers.c.c.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.inline_tuple_with_rational_numbers.c.c.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.inline_tuple_with_rational_numbers.c.codes.
