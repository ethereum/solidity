...
Require test.libsolidity.semanticTests.various.code_access_content.C.
Require test.libsolidity.semanticTests.various.code_access_content.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.code_access_content.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.code_access_content.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.code_access_content.C.codes.
