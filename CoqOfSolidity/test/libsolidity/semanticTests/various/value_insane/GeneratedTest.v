...
Require test.libsolidity.semanticTests.various.value_insane.helper.
Require test.libsolidity.semanticTests.various.value_insane.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.value_insane.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.value_insane.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.value_insane.test.codes.
