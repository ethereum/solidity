...
Require test.libsolidity.semanticTests.various.iszero_bnot_correct.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.iszero_bnot_correct.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.iszero_bnot_correct.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.iszero_bnot_correct.C.codes.
