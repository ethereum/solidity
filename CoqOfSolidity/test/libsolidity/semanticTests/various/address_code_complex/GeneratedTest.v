...
Require test.libsolidity.semanticTests.various.address_code_complex.A.
Require test.libsolidity.semanticTests.various.address_code_complex.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.address_code_complex.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.address_code_complex.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.address_code_complex.C.codes.
