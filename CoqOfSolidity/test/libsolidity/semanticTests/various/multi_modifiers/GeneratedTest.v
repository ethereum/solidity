...
Require test.libsolidity.semanticTests.various.multi_modifiers.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.multi_modifiers.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.multi_modifiers.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.multi_modifiers.C.codes.
