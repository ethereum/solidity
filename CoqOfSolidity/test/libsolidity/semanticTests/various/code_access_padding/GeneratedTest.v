...
Require test.libsolidity.semanticTests.various.code_access_padding.C.
Require test.libsolidity.semanticTests.various.code_access_padding.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.code_access_padding.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.code_access_padding.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.code_access_padding.C.codes.
