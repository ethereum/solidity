...
Require test.libsolidity.semanticTests.various.positive_integers_to_signed.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.positive_integers_to_signed.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.positive_integers_to_signed.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.positive_integers_to_signed.test.codes.
