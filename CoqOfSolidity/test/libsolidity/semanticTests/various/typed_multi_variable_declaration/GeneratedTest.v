...
Require test.libsolidity.semanticTests.various.typed_multi_variable_declaration.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.typed_multi_variable_declaration.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.typed_multi_variable_declaration.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.typed_multi_variable_declaration.C.codes.
