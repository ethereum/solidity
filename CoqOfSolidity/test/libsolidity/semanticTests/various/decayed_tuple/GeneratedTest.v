...
Require test.libsolidity.semanticTests.various.decayed_tuple.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.decayed_tuple.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.decayed_tuple.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.decayed_tuple.C.codes.
