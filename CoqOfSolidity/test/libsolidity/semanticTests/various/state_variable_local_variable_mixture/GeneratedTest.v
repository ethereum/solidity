...
Require test.libsolidity.semanticTests.various.state_variable_local_variable_mixture.A.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.state_variable_local_variable_mixture.A.A.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.state_variable_local_variable_mixture.A.A.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.state_variable_local_variable_mixture.A.codes.
