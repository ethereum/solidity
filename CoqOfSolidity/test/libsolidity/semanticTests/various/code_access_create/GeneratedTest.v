...
Require test.libsolidity.semanticTests.various.code_access_create.C.
Require test.libsolidity.semanticTests.various.code_access_create.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.code_access_create.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.code_access_create.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.code_access_create.C.codes.
