...
Require test.libsolidity.semanticTests.various.flipping_sign_tests.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.flipping_sign_tests.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.flipping_sign_tests.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.flipping_sign_tests.test.codes.
