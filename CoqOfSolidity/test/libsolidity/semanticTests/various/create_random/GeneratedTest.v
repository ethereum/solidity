...
Require test.libsolidity.semanticTests.various.create_random.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.create_random.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.create_random.C.C.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.various.create_random.C.codes.
