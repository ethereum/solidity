...
Require test.libsolidity.semanticTests.various.inline_member_init_inheritence.Base.
Require test.libsolidity.semanticTests.various.inline_member_init_inheritence.Derived.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.inline_member_init_inheritence.Derived.Derived.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.inline_member_init_inheritence.Derived.Derived.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.inline_member_init_inheritence.Derived.codes.
