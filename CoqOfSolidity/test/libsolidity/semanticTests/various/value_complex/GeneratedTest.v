...
Require test.libsolidity.semanticTests.various.value_complex.helper.
Require test.libsolidity.semanticTests.various.value_complex.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.value_complex.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.value_complex.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.value_complex.test.codes.
