...
Require test.libsolidity.semanticTests.various.balance.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.balance.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.balance.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.balance.test.codes.
