...
Require test.libsolidity.semanticTests.various.super_parentheses.A.
Require test.libsolidity.semanticTests.various.super_parentheses.B.
Require test.libsolidity.semanticTests.various.super_parentheses.C.
Require test.libsolidity.semanticTests.various.super_parentheses.D.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.super_parentheses.D.D.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.super_parentheses.D.D.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.super_parentheses.D.codes.
