...
Require test.libsolidity.semanticTests.various.state_variable_under_contract_name.Scope.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.state_variable_under_contract_name.Scope.Scope.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.state_variable_under_contract_name.Scope.Scope.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.state_variable_under_contract_name.Scope.codes.
