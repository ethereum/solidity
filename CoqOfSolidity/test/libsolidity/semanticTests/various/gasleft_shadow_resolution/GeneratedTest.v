...
Require test.libsolidity.semanticTests.various.gasleft_shadow_resolution.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.gasleft_shadow_resolution.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.gasleft_shadow_resolution.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.gasleft_shadow_resolution.C.codes.
