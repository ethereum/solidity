...
Require test.libsolidity.semanticTests.various.external_types_in_calls.C.
Require test.libsolidity.semanticTests.various.external_types_in_calls.C1.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.various.external_types_in_calls.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.various.external_types_in_calls.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.various.external_types_in_calls.C.codes.
