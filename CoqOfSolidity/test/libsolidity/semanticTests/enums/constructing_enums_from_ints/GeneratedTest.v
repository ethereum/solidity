...
Require test.libsolidity.semanticTests.enums.constructing_enums_from_ints.c.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.enums.constructing_enums_from_ints.c.c.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.enums.constructing_enums_from_ints.c.c.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.enums.constructing_enums_from_ints.c.codes.
