...
Require test.libsolidity.semanticTests.enums.using_enums.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.enums.using_enums.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.enums.using_enums.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.enums.using_enums.test.codes.
