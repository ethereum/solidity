...
Require test.libsolidity.semanticTests.enums.minmax.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.enums.minmax.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.enums.minmax.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.enums.minmax.test.codes.
