...
Require test.libsolidity.semanticTests.enums.using_inherited_enum.base.
Require test.libsolidity.semanticTests.enums.using_inherited_enum.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.enums.using_inherited_enum.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.enums.using_inherited_enum.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.enums.using_inherited_enum.test.codes.
