...
Require test.libsolidity.semanticTests.reverts.error_struct.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.reverts.error_struct.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.reverts.error_struct.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.reverts.error_struct.C.codes.
