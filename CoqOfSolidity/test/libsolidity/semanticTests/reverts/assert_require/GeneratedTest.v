...
Require test.libsolidity.semanticTests.reverts.assert_require.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.reverts.assert_require.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.reverts.assert_require.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.reverts.assert_require.C.codes.
