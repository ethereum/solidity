...
Require test.libsolidity.semanticTests.reverts.revert_return_area.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.reverts.revert_return_area.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.reverts.revert_return_area.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.reverts.revert_return_area.C.codes.
