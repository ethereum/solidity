...
Require test.libsolidity.semanticTests.reverts.invalid_enum_compared.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.reverts.invalid_enum_compared.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.reverts.invalid_enum_compared.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.reverts.invalid_enum_compared.C.codes.
