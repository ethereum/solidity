...
Require test.libsolidity.semanticTests.reverts.invalid_enum_stored.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.reverts.invalid_enum_stored.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.reverts.invalid_enum_stored.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.reverts.invalid_enum_stored.C.codes.
