...
Require test.libsolidity.semanticTests.reverts.revert.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.reverts.revert.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.reverts.revert.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.reverts.revert.C.codes.
