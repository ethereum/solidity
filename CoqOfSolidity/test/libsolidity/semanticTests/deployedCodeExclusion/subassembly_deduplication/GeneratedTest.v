...
Require test.libsolidity.semanticTests.deployedCodeExclusion.subassembly_deduplication.A.
Require test.libsolidity.semanticTests.deployedCodeExclusion.subassembly_deduplication.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.subassembly_deduplication.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.subassembly_deduplication.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.deployedCodeExclusion.subassembly_deduplication.C.codes.
