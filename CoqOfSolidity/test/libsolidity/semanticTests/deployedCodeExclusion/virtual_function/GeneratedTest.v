...
Require test.libsolidity.semanticTests.deployedCodeExclusion.virtual_function.C.
Require test.libsolidity.semanticTests.deployedCodeExclusion.virtual_function.S.
Require test.libsolidity.semanticTests.deployedCodeExclusion.virtual_function.X.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.virtual_function.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.virtual_function.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.deployedCodeExclusion.virtual_function.C.codes.
