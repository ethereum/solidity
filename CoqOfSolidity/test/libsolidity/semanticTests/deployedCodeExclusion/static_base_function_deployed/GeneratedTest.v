...
Require test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function_deployed.C.
Require test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function_deployed.S.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function_deployed.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function_deployed.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function_deployed.C.codes.
