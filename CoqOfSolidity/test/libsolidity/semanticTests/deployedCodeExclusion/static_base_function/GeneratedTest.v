...
Require test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function.C.
Require test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function.S.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.deployedCodeExclusion.static_base_function.C.codes.
