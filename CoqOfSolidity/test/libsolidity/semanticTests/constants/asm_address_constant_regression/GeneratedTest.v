...
Require test.libsolidity.semanticTests.constants.asm_address_constant_regression.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.constants.asm_address_constant_regression.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.constants.asm_address_constant_regression.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.constants.asm_address_constant_regression.C.codes.
