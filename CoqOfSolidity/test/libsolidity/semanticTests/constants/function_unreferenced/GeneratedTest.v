...
Require test.libsolidity.semanticTests.constants.function_unreferenced.B.
Require test.libsolidity.semanticTests.constants.function_unreferenced.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.constants.function_unreferenced.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.constants.function_unreferenced.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.constants.function_unreferenced.C.codes.
