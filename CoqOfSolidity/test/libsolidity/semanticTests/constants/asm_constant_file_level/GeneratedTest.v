...
Require test.libsolidity.semanticTests.constants.asm_constant_file_level.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.constants.asm_constant_file_level.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.constants.asm_constant_file_level.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.constants.asm_constant_file_level.C.codes.
