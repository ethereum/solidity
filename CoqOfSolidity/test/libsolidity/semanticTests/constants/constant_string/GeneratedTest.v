...
Require test.libsolidity.semanticTests.constants.constant_string.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.constants.constant_string.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.constants.constant_string.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.constants.constant_string.C.codes.
