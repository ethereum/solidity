...
Require test.libsolidity.semanticTests.literals.wei.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.literals.wei.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.literals.wei.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.literals.wei.C.codes.
