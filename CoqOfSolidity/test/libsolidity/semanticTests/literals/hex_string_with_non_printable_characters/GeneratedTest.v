...
Require test.libsolidity.semanticTests.literals.hex_string_with_non_printable_characters.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.literals.hex_string_with_non_printable_characters.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.literals.hex_string_with_non_printable_characters.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.literals.hex_string_with_non_printable_characters.C.codes.
