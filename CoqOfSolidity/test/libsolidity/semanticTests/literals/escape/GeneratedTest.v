...
Require test.libsolidity.semanticTests.literals.escape.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.literals.escape.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.literals.escape.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.literals.escape.C.codes.
