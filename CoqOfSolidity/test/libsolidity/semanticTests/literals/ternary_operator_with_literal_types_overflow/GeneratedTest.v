...
Require test.libsolidity.semanticTests.literals.ternary_operator_with_literal_types_overflow.TestTernary.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.literals.ternary_operator_with_literal_types_overflow.TestTernary.TestTernary.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.literals.ternary_operator_with_literal_types_overflow.TestTernary.TestTernary.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.literals.ternary_operator_with_literal_types_overflow.TestTernary.codes.
