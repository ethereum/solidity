...
Require test.libsolidity.semanticTests.literals.gwei.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.literals.gwei.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.literals.gwei.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.literals.gwei.C.codes.
