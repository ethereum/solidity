...
Require test.libsolidity.semanticTests.ecrecover.ecrecover.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.ecrecover.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.ecrecover.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.ecrecover.ecrecover.test.codes.
