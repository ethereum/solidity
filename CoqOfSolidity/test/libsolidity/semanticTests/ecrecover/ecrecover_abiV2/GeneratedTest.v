...
Require test.libsolidity.semanticTests.ecrecover.ecrecover_abiV2.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.ecrecover_abiV2.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.ecrecover_abiV2.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.ecrecover.ecrecover_abiV2.test.codes.
