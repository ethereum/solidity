...
Require test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input.C.codes.
