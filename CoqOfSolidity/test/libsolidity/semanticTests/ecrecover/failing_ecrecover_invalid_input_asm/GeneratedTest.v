...
Require test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.ecrecover.failing_ecrecover_invalid_input_asm.C.codes.
