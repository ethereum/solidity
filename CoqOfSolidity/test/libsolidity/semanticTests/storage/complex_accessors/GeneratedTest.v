...
Require test.libsolidity.semanticTests.storage.complex_accessors.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.complex_accessors.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.complex_accessors.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.complex_accessors.test.codes.
