...
Require test.libsolidity.semanticTests.storage.packed_storage_structs_bytes.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.packed_storage_structs_bytes.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.packed_storage_structs_bytes.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.packed_storage_structs_bytes.C.codes.
