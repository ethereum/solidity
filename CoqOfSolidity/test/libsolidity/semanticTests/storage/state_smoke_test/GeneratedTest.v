...
Require test.libsolidity.semanticTests.storage.state_smoke_test.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.state_smoke_test.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.state_smoke_test.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.state_smoke_test.test.codes.
