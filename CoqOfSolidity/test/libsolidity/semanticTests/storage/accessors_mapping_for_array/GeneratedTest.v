...
Require test.libsolidity.semanticTests.storage.accessors_mapping_for_array.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.accessors_mapping_for_array.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.accessors_mapping_for_array.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.accessors_mapping_for_array.test.codes.
