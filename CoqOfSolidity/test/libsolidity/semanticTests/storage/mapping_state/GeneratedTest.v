...
Require test.libsolidity.semanticTests.storage.mapping_state.Ballot.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.mapping_state.Ballot.Ballot.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.mapping_state.Ballot.Ballot.deployed.code.

Definition codes : list Code.t :=
  test.libsolidity.semanticTests.storage.mapping_state.Ballot.codes.
