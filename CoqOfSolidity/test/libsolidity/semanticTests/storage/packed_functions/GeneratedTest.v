...
Require test.libsolidity.semanticTests.storage.packed_functions.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.packed_functions.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.packed_functions.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.packed_functions.C.codes.
