...
Require test.libsolidity.semanticTests.storage.packed_storage_structs_uint.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.packed_storage_structs_uint.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.packed_storage_structs_uint.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.packed_storage_structs_uint.C.codes.
