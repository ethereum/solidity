...
Require test.libsolidity.semanticTests.storage.mappings_array2d_pop_delete.C.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.mappings_array2d_pop_delete.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.mappings_array2d_pop_delete.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.mappings_array2d_pop_delete.C.codes.
