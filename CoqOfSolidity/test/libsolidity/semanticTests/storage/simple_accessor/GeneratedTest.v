...
Require test.libsolidity.semanticTests.storage.simple_accessor.test.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.storage.simple_accessor.test.test.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.storage.simple_accessor.test.test.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.storage.simple_accessor.test.codes.
