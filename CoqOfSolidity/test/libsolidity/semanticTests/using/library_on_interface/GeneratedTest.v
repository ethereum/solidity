...
Require test.libsolidity.semanticTests.using.library_on_interface.C.
Require test.libsolidity.semanticTests.using.library_on_interface.I.
Require test.libsolidity.semanticTests.using.library_on_interface.L.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.using.library_on_interface.C.C.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.using.library_on_interface.C.C.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.using.library_on_interface.C.codes.
