...
Require test.libsolidity.semanticTests.state_variables_init_order.A.
Require test.libsolidity.semanticTests.state_variables_init_order.B.

Definition constructor_code : Code.t :=
  test.libsolidity.semanticTests.state_variables_init_order.B.B.code.

Definition deployed_code : Code.t :=
  test.libsolidity.semanticTests.state_variables_init_order.B.B.deployed.code.

Definition codes : list (U256.t * M.t BlockUnit.t) :=
  test.libsolidity.semanticTests.state_variables_init_order.B.codes.
