...
This documentation is translated into several languages, of which the English
translation should be most up to date.

* `Spanish <https://solidity-es.readthedocs.io>`_ (community-maintained)
