...
first block of the ``try`` statement. This block is called the *success block*.
If the end of the success block is reached, execution continues after the last ``catch`` block.
