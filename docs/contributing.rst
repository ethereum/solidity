...
you need to install `aleth <https://github.com/ethereum/aleth/releases/download/v1.6.0-alpha.1/aleth-1.6.0-alpha.1-linux-x86_64.tar.gz>`_ and run it in testing mode: ``aleth --db memorydb --test -d /tmp/testeth``.
