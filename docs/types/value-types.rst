...
.. warning::
    ...
    To reduce conversion ambiguity version 0.4.24 and higher versions of the solidity compiler force you to make the truncation explicit in the conversion.
