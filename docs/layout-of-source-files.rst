...
The version pragma is used as follows: ``pragma solidity ^0.5.8;``

A source file with the line above does not compile with a compiler earlier than version 0.5.8,
