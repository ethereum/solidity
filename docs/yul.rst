...
This will use the :ref:`Specification of Yul Object <yul-object>` so that it is possible to refer
...
Please see :ref:`Specification of Yul Object <yul-object>` below for details on that.
