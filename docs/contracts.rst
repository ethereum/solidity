...
API, this is done as follows::
    ...
    var source = "pragma solidity ^0.4.0; contract CONTRACT_NAME { function CONTRACT_NAME(uint a, uint b) {} }";

    web3.setProvider(new web3.providers.HttpProvider("http://localhost:8545"))      // Assuming you have eth or testrpc running
    var compiled = web3.eth.compile.solidity(source);

    MyContract = web3.eth.contract(compiled.info.abiDefinition);
    // deploy new contract
    var contractInstance = MyContract.new(
        10,
        11,
        {from: myAccount, gas: 1000000, data: compiled.code}
    );
