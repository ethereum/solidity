...
/// std::apply_visitor(GenericVisitor<Class1, Class2>(
///     [](Class1& _c) { _c.f(); },
///     [](Class2& _c) { _c.g(); }
/// ), variant);
...
/// std::apply_visitor(GenericFallbackVisitor<Class1, Class2>(
///     [](Class1& _c) { _c.f(); },
///     [](Class2& _c) { _c.g(); }
/// ), variant);
...
/// std::apply_visitor(GenericFallbackReturnsVisitor<ReturnType, Class1, Class2>(
