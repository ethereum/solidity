...
#if defined(__APPLE__)
		io.AddMousePosEvent(mouse_pos.x * 2, mouse_pos.y * 2);
#else
...
bool ImGui_ImplSDL2_InitForMetal(SDL_Window* window) { return ImGui_ImplSDL2_Init(window, NULL, NULL); }
...
#if defined(__APPLE__)
			io.AddMousePosEvent((float) mouse_x * 2, (float) mouse_y * 2);
#else
