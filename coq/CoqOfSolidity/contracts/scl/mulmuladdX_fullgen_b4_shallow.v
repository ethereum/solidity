...
Module FooBar_90.
  ...
  Definition body : M.t unit :=
    do~
      ...
      let~ _2 := [[ datasize ~(| 0x466f6f4261725f39305f6465706c6f7965640000000000000000000000000000 |) ]] in
      do~ [[ codecopy ~(| _1, (dataoffset ~(| 0x466f6f4261725f39305f6465706c6f7965640000000000000000000000000000 |)), _2 |) ]] in
      do~ [[ return_ ~(| _1, _2 |) ]] in
      M.pure tt
    in
    M.pure tt.

  Module FooBar_90_deployed.
    Definition usr'dollar'ecAddn2_2185 (usr'dollar'x1 : U256.t) (usr'dollar'y1 : U256.t) (usr'dollar'x2 : U256.t) (usr'dollar'y2 : U256.t) (usr_p : U256.t) : M.t (U256.t * U256.t * U256.t * U256.t) :=
    ...
    Definition fun_ecGenMulmuladdX_store_2808 : M.t unit :=
      do~ [[ mstore ~(| 0xa0, 0 |) ]] in
      ...
      let~ '(var_X_1, var_Y_1, var_ZZ, var_ZZZ) := [[ usr'dollar'ecAddn2_2185 ~(| var_X, var_Y, (mload ~(| _5 |)), (mload ~(| _3 |)), usr_modulusp |) ]] in
      ...
      let~ '(var_X_2, var_Y_2, var_ZZ_1, var_ZZZ_1) := [[ usr'dollar'ecAddn2_2185 ~(| (mload ~(| (mload ~(| 0x0140 |)) |)), (mload ~(| _17 |)), _16, _15, usr_modulusp |) ]] in
      ...
      let~ '(var_X_4, var_Y_4, var_ZZ_2, var_ZZZ_2) := [[ usr'dollar'ecAddn2_2185 ~(| var_X_3, var_Y_3, (mload ~(| (mload ~(| 0x0140 |)) |)), (mload ~(| _17 |)), usr_modulusp |) ]] in
      ...
      let~ '(var_X_6, var_Y_6, var_ZZ_4, var_ZZZ_4) := [[ usr'dollar'ecAddn2_2185 ~(| (mload ~(| _23 |)), (mload ~(| _21 |)), (mload ~(| _5 |)), (mload ~(| _3 |)), (mload ~(| (add ~(| _26, 2080 |)) |)) |) ]] in
      ...
      let~ '(var_X_8, var_Y_8, var_ZZ_5, var_ZZZ_5) := [[ usr'dollar'ecAddn2_2185 ~(| (mload ~(| _23 |)), (mload ~(| _21 |)), var_X_7, var_Y_7, (mload ~(| (add ~(| _27, 2080 |)) |)) |) ]] in
      ...
      let~ '(var_X_10, var_Y_10, var_ZZ_7, var_ZZZ_7) := [[ usr'dollar'ecAddn2_2185 ~(| (mload ~(| (mload ~(| 0x0140 |)) |)), (mload ~(| _17 |)), (mload ~(| _23 |)), (mload ~(| _21 |)), (mload ~(| (add ~(| _29, 2080 |)) |)) |) ]] in
      ...
      do~
        ...
        M.for_unit
          ...
          do~ [[
            M.if_unit (| iszero ~(| usr'dollar'T1 |),
          ...
          do~ [[
            M.if_unit (| iszero ~(| _36 |),
              do~ [[
                M.if_unit (| iszero ~(| usr'dollar'T2 |),
      ...
      do~ [[
        M.if_unit (| iszero ~(| (staticcall ~(| (not ~(| 0 |)), 0x05, 2176, 192, 2176, 32 |)) |),
          do~ [[ revert ~(| 2047, 32 |) ]] in
          M.pure tt
        |)
      ]] in
    ...
    Definition fun_ecGenMulmuladdX_store (var_Q_mpos : U256.t) (var_scalar_u : U256.t) (var_scalar_v : U256.t) : M.t U256.t :=
      ...
      do~ [[ mstore ~(| 0xa0, 0 |) ]] in
      do~ [[ fun_ecGenMulmuladdX_store_2808 ~(||) ]] in
