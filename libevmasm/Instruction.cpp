...
std::map<std::string, Instruction, std::less<>> const solidity::evmasm::c_instructions =
{
	...
	{ "CALLSUB", Instruction::CALLSUB },
	{ "CALLDEST", Instruction::CALLDEST },
...
{   //                                                Add Args Ret SideEffects GasPriceTier
	...
	{Instruction::CALLSUB,        {"CALLSUB",         0,  1,   0,  true,       Tier::Mid}},
	{Instruction::CALLDEST,       {"CALLDEST",        0,  0,   0,  true,       Tier::Special}},
