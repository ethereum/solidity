...
AssemblyItem Pattern::toAssemblyItem(yul::DebugData::ConstPtr const& _debugData) const
{
	if (m_type == Operation)
...
ExpressionTemplate::ExpressionTemplate(Pattern const& _pattern, yul::DebugData::ConstPtr const& _debugData)
{
