...
private:
	...
	void appendDup(int _fromPosition,  yul::DebugData::ConstPtr const& _debugData);
	...
	void appendOrRemoveSwap(int _fromPosition,  yul::DebugData::ConstPtr const& _debugData);
