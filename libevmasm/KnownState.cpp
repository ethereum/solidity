...
ExpressionClasses::Id KnownState::stackElement(int _stackHeight, yul::DebugData::ConstPtr _debugData)
{
...
KnownState::Id KnownState::relativeStackElement(int _stackOffset, yul::DebugData::ConstPtr _debugData)
{
...
void KnownState::swapStackElements(
	int _stackHeightA,
	int _stackHeightB,
	yul::DebugData::ConstPtr _debugData
)
{
...
ExpressionClasses::Id KnownState::loadFromStorage(Id _slot, yul::DebugData::ConstPtr _debugData)
{
...
KnownState::StoreOperation KnownState::storeInMemory(Id _slot, Id _value, yul::DebugData::ConstPtr _debugData)
{
...
ExpressionClasses::Id KnownState::loadFromMemory(Id _slot, yul::DebugData::ConstPtr _debugData)
{
