...
Scope::Function const& ControlFlowGraphBuilder::lookupFunction(YulName const _name) const
{
...
Scope::Variable const& ControlFlowGraphBuilder::lookupVariable(YulName const _name) const
{
	yulAssert(m_scope, "");
