...
void SSAControlFlowGraphBuilder::operator()(Block const& _block)
{
	...
	{
		auto const filterFunctionDefinitions = [](bool _yieldDefinitions)
		{
			return [b=_yieldDefinitions](Statement const& _statement) -> bool { return !b ^ std::holds_alternative<FunctionDefinition>(_statement);};
		};
