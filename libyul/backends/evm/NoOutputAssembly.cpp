...
{
	auto const& returns = _builtin.numReturns;
	auto const& fun = _builtin;
	_builtin.generateCode = [returns, fun](FunctionCall const& _call, AbstractAssembly& _assembly, BuiltinContext&)
	{
