...
)
{
	...
	std::vector<FunctionCall*> memoryGuardCalls = findFunctionCalls(_block, "memoryguard"_yulname);
	...
	for (FunctionCall* memoryGuardCall: findFunctionCalls(_block, "memoryguard"_yulname))
	{
