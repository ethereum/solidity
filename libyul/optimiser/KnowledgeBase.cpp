...
bool KnowledgeBase::knownToBeDifferent(YulString _a, YulString _b)
{
	...
	if (optional<u256> difference = differenceIsKnownConstant(_a, _b))
		return difference != 0;
...
optional<u256> KnowledgeBase::differenceIsKnownConstant(YulString _a, YulString _b)
{
	// Try to use the simplification rules together with the
...
{
	return knownConstant(_a) == u256{};
}

optional<u256> KnowledgeBase::knownConstant(YulString _a)
{
